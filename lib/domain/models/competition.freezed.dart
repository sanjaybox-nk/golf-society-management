...
mixin _$CompetitionRules {
 ...
 bool? get separateGuests;// [UPDATED] Single override: null = follow society, true = separate, false = hidden
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,format,subtype,mode,handicapMode,handicapCap,handicapAllowance,teamHandicapCap,underlyingFormat,useCourseAllowance,maxScoreConfig,roundsCount,aggregation,tieBreak,holeByHoleRequired,minDrivesPerPlayer,useWHSScrambleAllowance,trackShotAttributions,applyCapToIndex,teamBestXCount,teamSize,useMixedTeeAdjustment,teamHandicapMethod,separateGuests,const DeepCollectionEquality().hash(oomExcludedRoundIds)]);
...
as TeamHandicapMethod,separateGuests: freezed == separateGuests ? _self.separateGuests : separateGuests // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CompetitionFormat format,  CompetitionSubtype subtype,  CompetitionMode mode,  HandicapMode handicapMode,  int handicapCap,  double handicapAllowance,  int? teamHandicapCap,  CompetitionFormat underlyingFormat,  bool useCourseAllowance,  MaxScoreConfig? maxScoreConfig,  int roundsCount,  AggregationMethod aggregation,  TieBreakMethod tieBreak,  bool holeByHoleRequired,  int minDrivesPerPlayer,  bool useWHSScrambleAllowance,  bool trackShotAttributions,  bool applyCapToIndex,  int teamBestXCount,  int teamSize,  bool useMixedTeeAdjustment,  TeamHandicapMethod teamHandicapMethod,  bool? separateGuests,  List<String> oomExcludedRoundIds)  $default,) {final _that = this;
switch (_that) {
case _CompetitionRules():
return $default(_that.format,_that.subtype,_that.mode,_that.handicapMode,_that.handicapCap,_that.handicapAllowance,_that.teamHandicapCap,_that.underlyingFormat,_that.useCourseAllowance,_that.maxScoreConfig,_that.roundsCount,_that.aggregation,_that.tieBreak,_that.holeByHoleRequired,_that.minDrivesPerPlayer,_that.useWHSScrambleAllowance,_that.trackShotAttributions,_that.applyCapToIndex,_that.teamBestXCount,_that.teamSize,_that.useMixedTeeAdjustment,_that.teamHandicapMethod,_that.separateGuests,_that.oomExcludedRoundIds);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,format,subtype,mode,handicapMode,handicapCap,handicapAllowance,teamHandicapCap,underlyingFormat,useCourseAllowance,maxScoreConfig,roundsCount,aggregation,tieBreak,holeByHoleRequired,minDrivesPerPlayer,useWHSScrambleAllowance,trackShotAttributions,applyCapToIndex,teamBestXCount,teamSize,useMixedTeeAdjustment,teamHandicapMethod,separateGuests,const DeepCollectionEquality().hash(_oomExcludedRoundIds)]);
