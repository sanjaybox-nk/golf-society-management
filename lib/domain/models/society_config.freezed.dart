...
@useResult
$Res call({
 String societyName, String? logoUrl, int primaryColor, int secondaryColor, int backgroundColor, String brandingStyle, bool useShadows, double shadowIntensity, bool useBorders, double borderWidth, double pillRadius, double buttonRadius, double heroRadius, double shadowSpread, double shadowOpacity, String themeMode, List<int> customColors, double cardTintIntensity, bool useCardGradient, String currencySymbol, String currencyCode, String groupingStrategy, bool useWhsHandicaps, String distanceUnit, HandicapSystem handicapSystem, String? selectedPaletteName, bool separateGuestLeaderboard, SocietyCutMode societyCutMode, Map<String, double> societyCutRules, double globalMarkupPercentage, double guestMarkupExtra
});
...
switch (_that) {
case _SocietyConfig() when $default != null:
return $default(_that.societyName,_that.logoUrl,_that.primaryColor,_that.secondaryColor,_that.backgroundColor,_that.brandingStyle,_that.useShadows,_that.shadowIntensity,_that.useBorders,_that.borderWidth,_that.pillRadius,_that.buttonRadius,_that.heroRadius,_that.shadowSpread,_that.shadowOpacity,_that.themeMode,_that.customColors,_that.cardTintIntensity,_that.useCardGradient,_that.currencySymbol,_that.currencyCode,_that.groupingStrategy,_that.useWhsHandicaps,_that.distanceUnit,_that.handicapSystem,_that.selectedPaletteName,_that.separateGuestLeaderboard,_that.societyCutMode,_that.societyCutRules,_that.globalMarkupPercentage,_that.guestMarkupExtra);case _:
  return orElse();
...
class _SocietyConfig implements SocietyConfig {
  const _SocietyConfig({this.societyName = 'Golf Society', this.logoUrl, this.primaryColor = 0xFFF7D354, this.secondaryColor = 0xFF4ADE80, this.backgroundColor = 0xFFEFEFED, this.brandingStyle = 'boxy', this.useShadows = true, this.shadowIntensity = 1.0, this.useBorders = true, this.borderWidth = 1.5, this.pillRadius = 30.0, this.buttonRadius = 30.0, this.heroRadius = 28.0, this.shadowSpread = 0.0, this.shadowOpacity = 0.12, this.themeMode = 'system', final  List<int> customColors = const [], this.cardTintIntensity = 0.1, this.useCardGradient = true, this.currencySymbol = '£', this.currencyCode = 'GBP', this.groupingStrategy = 'balanced', this.useWhsHandicaps = true, this.distanceUnit = 'yards', this.handicapSystem = HandicapSystem.igolf, this.selectedPaletteName, this.separateGuestLeaderboard = true, this.societyCutMode = SocietyCutMode.off, final  Map<String, double> societyCutRules = const {'1st' : 2.0, '2nd' : 1.0, '3rd' : 0.5}, this.globalMarkupPercentage = 0.10, this.guestMarkupExtra = 10.0}): _customColors = customColors,_societyCutRules = societyCutRules;
