...
class ContrastHelper {
  /// Returns Colors.black or AppColors.pureWhite based on the luminance of the background color.
  ...
  static Color getContrastingText(Color backgroundColor) {
    return backgroundColor.computeLuminance() > 0.5 ? Colors.black : AppColors.pureWhite;
  }
}
