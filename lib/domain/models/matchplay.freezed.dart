...
mixin _$MatchplayResult {
  String get winnerId;
  String get scoreDisplay; // e.g., "3 & 2", "1 Up", "2 Up"
  List<int>
      get holeWins; // 1 for Player A win, -1 for Player B win, 0 for halved
  bool get isWalkover;
  ...
  $MatchplayResultCopyWith<MatchplayResult> get copyWith =>
      _$MatchplayResultCopyWithImpl<MatchplayResult>(
          this as MatchplayResult, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MatchplayResult &&
            (identical(other.winnerId, winnerId) ||
                other.winnerId == winnerId) &&
            (identical(other.scoreDisplay, scoreDisplay) ||
                other.scoreDisplay == scoreDisplay) &&
            const DeepCollectionEquality().equals(other.holeWins, holeWins) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, winnerId, scoreDisplay,
      const DeepCollectionEquality().hash(holeWins), isWalkover);
...
abstract mixin class $MatchplayResultCopyWith<$Res> {
  factory $MatchplayResultCopyWith(
          MatchplayResult value, $Res Function(MatchplayResult) _then) =
      _$MatchplayResultCopyWithImpl;
  @useResult
  $Res call(
      {String winnerId,
      String scoreDisplay,
...
class _$MatchplayResultCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? scoreDisplay = null,
    Object? holeWins = null,
    ...
    return _then(_self.copyWith(
      ...
      scoreDisplay: null == scoreDisplay
          ? _self.scoreDisplay
          : scoreDisplay // ignore: cast_nullable_to_non_nullable
              as String,
      holeWins: null == holeWins
          ? _self.holeWins
          : holeWins // ignore: cast_nullable_to_non_nullable
              as List<int>,
...
extension MatchplayResultPatterns on MatchplayResult {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MatchplayResult value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String winnerId, String scoreDisplay, List<int> holeWins,
            bool isWalkover)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _MatchplayResult() when $default != null:
        return $default(_that.winnerId, _that.scoreDisplay, _that.holeWins,
            _that.isWalkover);
      case _:
        return orElse();
    }
...
class _MatchplayResult implements MatchplayResult {
  const _MatchplayResult(
      {required this.winnerId,
      required this.scoreDisplay,
      final List<int> holeWins = const [],
      this.isWalkover = false})
      : _holeWins = holeWins;
  factory _MatchplayResult.fromJson(Map<String, dynamic> json) =>
...
// 1 for Player A win, -1 for Player B win, 0 for halved
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MatchplayResultCopyWith<_MatchplayResult> get copyWith =>
      __$MatchplayResultCopyWithImpl<_MatchplayResult>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MatchplayResultToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MatchplayResult &&
            (identical(other.winnerId, winnerId) ||
                other.winnerId == winnerId) &&
            (identical(other.scoreDisplay, scoreDisplay) ||
                other.scoreDisplay == scoreDisplay) &&
            const DeepCollectionEquality().equals(other._holeWins, _holeWins) &&
            (identical(other.isWalkover, isWalkover) ||
                other.isWalkover == isWalkover));
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, winnerId, scoreDisplay,
      const DeepCollectionEquality().hash(_holeWins), isWalkover);
...
/// @nodoc
abstract mixin class _$MatchplayResultCopyWith<$Res>
    implements $MatchplayResultCopyWith<$Res> {
  factory _$MatchplayResultCopyWith(
          _MatchplayResult value, $Res Function(_MatchplayResult) _then) =
      __$MatchplayResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String winnerId,
...
mixin _$MatchplayMatch {
  String get id;
  String get playerAId;
  String get playerBId;
  String? get playerAName;
  String? get playerBName;
  double get playerAHandicap;
  double get playerBHandicap;
  int get strokesReceived; // Result of (A-B) * allowance
  MatchplayStatus get status;
  MatchplayResult? get result;
  String? get eventId; // Link to a specific society event if played during one
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MatchplayMatchCopyWith<MatchplayMatch> get copyWith =>
      _$MatchplayMatchCopyWithImpl<MatchplayMatch>(
          this as MatchplayMatch, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.playerAName, playerAName) ||
                other.playerAName == playerAName) &&
            (identical(other.playerBName, playerBName) ||
                other.playerBName == playerBName) &&
            (identical(other.playerAHandicap, playerAHandicap) ||
                other.playerAHandicap == playerAHandicap) &&
            (identical(other.playerBHandicap, playerBHandicap) ||
                other.playerBHandicap == playerBHandicap) &&
...
abstract mixin class $MatchplayMatchCopyWith<$Res> {
  factory $MatchplayMatchCopyWith(
          MatchplayMatch value, $Res Function(MatchplayMatch) _then) =
      _$MatchplayMatchCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String playerAId,
      ...
      String? playerAName,
      String? playerBName,
      double playerAHandicap,
      double playerBHandicap,
      int strokesReceived,
...
class _$MatchplayMatchCopyWithImpl<$Res>
  ...
  $Res call({
    Object? id = null,
    Object? playerAId = null,
    Object? playerBId = null,
    Object? playerAName = freezed,
    Object? playerBName = freezed,
    Object? playerAHandicap = null,
    Object? playerBHandicap = null,
    ...
    return _then(_self.copyWith(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as String,
      playerAId: null == playerAId
          ? _self.playerAId
          : playerAId // ignore: cast_nullable_to_non_nullable
              as String,
      playerBId: null == playerBId
          ? _self.playerBId
          : playerBId // ignore: cast_nullable_to_non_nullable
              as String,
      playerAName: freezed == playerAName
          ? _self.playerAName
          : playerAName // ignore: cast_nullable_to_non_nullable
              as String?,
      playerBName: freezed == playerBName
          ? _self.playerBName
          : playerBName // ignore: cast_nullable_to_non_nullable
              as String?,
      playerAHandicap: null == playerAHandicap
          ? _self.playerAHandicap
          : playerAHandicap // ignore: cast_nullable_to_non_nullable
              as double,
      playerBHandicap: null == playerBHandicap
          ? _self.playerBHandicap
          : playerBHandicap // ignore: cast_nullable_to_non_nullable
              as double,
      strokesReceived: null == strokesReceived
          ? _self.strokesReceived
...
extension MatchplayMatchPatterns on MatchplayMatch {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MatchplayMatch value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
    ...
    switch (_that) {
      case _MatchplayMatch() when $default != null:
        return $default(
            ...
            _that.playerAName,
            _that.playerBName,
            _that.playerAHandicap,
            _that.playerBHandicap,
            _that.strokesReceived,
            _that.status,
            _that.result,
            _that.eventId,
            _that.playedDate);
...
class _MatchplayMatch implements MatchplayMatch {
  const _MatchplayMatch(
      {required this.id,
      required this.playerAId,
      required this.playerBId,
      this.playerAName,
      this.playerBName,
      required this.playerAHandicap,
      required this.playerBHandicap,
      required this.strokesReceived,
      this.status = MatchplayStatus.scheduled,
      this.result,
      this.eventId,
      @OptionalTimestampConverter() this.playedDate});
  factory _MatchplayMatch.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  final double playerAHandicap;
  @override
  final double playerBHandicap;
  @override
  final int strokesReceived;
// Result of (A-B) * allowance
  @override
  @JsonKey()
  final MatchplayStatus status;
  @override
  final MatchplayResult? result;
  @override
...
// Link to a specific society event if played during one
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MatchplayMatchCopyWith<_MatchplayMatch> get copyWith =>
      __$MatchplayMatchCopyWithImpl<_MatchplayMatch>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MatchplayMatchToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$MatchplayMatchCopyWith<$Res>
    implements $MatchplayMatchCopyWith<$Res> {
  factory _$MatchplayMatchCopyWith(
          _MatchplayMatch value, $Res Function(_MatchplayMatch) _then) =
      __$MatchplayMatchCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$MatchplayRound {
  String get id;
  String get name; // e.g., "Quarter Finals"
  List<MatchplayMatch> get matches;
  @TimestampConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MatchplayRoundCopyWith<MatchplayRound> get copyWith =>
      _$MatchplayRoundCopyWithImpl<MatchplayRound>(
          this as MatchplayRound, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, id, name,
      const DeepCollectionEquality().hash(matches), deadline);
...
abstract mixin class $MatchplayRoundCopyWith<$Res> {
  factory $MatchplayRoundCopyWith(
          MatchplayRound value, $Res Function(MatchplayRound) _then) =
      _$MatchplayRoundCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String name,
      List<MatchplayMatch> matches,
...
extension MatchplayRoundPatterns on MatchplayRound {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MatchplayRound value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, List<MatchplayMatch> matches,
            @TimestampConverter() DateTime deadline)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _MatchplayRound() when $default != null:
        return $default(_that.id, _that.name, _that.matches, _that.deadline);
      case _:
        return orElse();
    }
  }
...
class _MatchplayRound implements MatchplayRound {
  const _MatchplayRound(
      {required this.id,
      required this.name,
      final List<MatchplayMatch> matches = const [],
      @TimestampConverter() required this.deadline})
      : _matches = matches;
  factory _MatchplayRound.fromJson(Map<String, dynamic> json) =>
...
// e.g., "Quarter Finals"
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MatchplayRoundCopyWith<_MatchplayRound> get copyWith =>
      __$MatchplayRoundCopyWithImpl<_MatchplayRound>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MatchplayRoundToJson(
      this,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name,
      const DeepCollectionEquality().hash(_matches), deadline);
...
/// @nodoc
abstract mixin class _$MatchplayRoundCopyWith<$Res>
    implements $MatchplayRoundCopyWith<$Res> {
  factory _$MatchplayRoundCopyWith(
          _MatchplayRound value, $Res Function(_MatchplayRound) _then) =
      __$MatchplayRoundCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$MatchplayComp {
  ...
  String get title;
  bool get isActive;
  List<MatchplayRound> get rounds;
  double get handicapAllowance; // Usually full difference or 90%
  @TimestampConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MatchplayCompCopyWith<MatchplayComp> get copyWith =>
      _$MatchplayCompCopyWithImpl<MatchplayComp>(
          this as MatchplayComp, _$identity);
...
abstract mixin class $MatchplayCompCopyWith<$Res> {
  factory $MatchplayCompCopyWith(
          MatchplayComp value, $Res Function(MatchplayComp) _then) =
      _$MatchplayCompCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String title,
      bool isActive,
      List<MatchplayRound> rounds,
...
extension MatchplayCompPatterns on MatchplayComp {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MatchplayComp value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _MatchplayComp() when $default != null:
        return $default(_that.id, _that.title, _that.isActive, _that.rounds,
            _that.handicapAllowance, _that.createdAt);
      case _:
        return orElse();
    }
  }
...
class _MatchplayComp implements MatchplayComp {
  const _MatchplayComp(
      {required this.id,
      required this.title,
      this.isActive = true,
      final List<MatchplayRound> rounds = const [],
      this.handicapAllowance = 1.0,
      @TimestampConverter() required this.createdAt})
      : _rounds = rounds;
  factory _MatchplayComp.fromJson(Map<String, dynamic> json) =>
...
// Usually full difference or 90%
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MatchplayCompCopyWith<_MatchplayComp> get copyWith =>
      __$MatchplayCompCopyWithImpl<_MatchplayComp>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MatchplayCompToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$MatchplayCompCopyWith<$Res>
    implements $MatchplayCompCopyWith<$Res> {
  factory _$MatchplayCompCopyWith(
          _MatchplayComp value, $Res Function(_MatchplayComp) _then) =
      __$MatchplayCompCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
