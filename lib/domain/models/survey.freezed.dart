...
mixin _$SurveyQuestion {
  ...
  $SurveyQuestionCopyWith<SurveyQuestion> get copyWith =>
      _$SurveyQuestionCopyWithImpl<SurveyQuestion>(
          this as SurveyQuestion, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, id, question, type,
      const DeepCollectionEquality().hash(options), isRequired);
...
abstract mixin class $SurveyQuestionCopyWith<$Res> {
  factory $SurveyQuestionCopyWith(
          SurveyQuestion value, $Res Function(SurveyQuestion) _then) =
      _$SurveyQuestionCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String question,
...
extension SurveyQuestionPatterns on SurveyQuestion {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SurveyQuestion value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String question, SurveyQuestionType type,
            List<String> options, bool isRequired)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SurveyQuestion() when $default != null:
        return $default(_that.id, _that.question, _that.type, _that.options,
            _that.isRequired);
      case _:
        return orElse();
    }
...
class _SurveyQuestion implements SurveyQuestion {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SurveyQuestionCopyWith<_SurveyQuestion> get copyWith =>
      __$SurveyQuestionCopyWithImpl<_SurveyQuestion>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SurveyQuestionToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SurveyQuestionCopyWith<$Res>
    implements $SurveyQuestionCopyWith<$Res> {
  factory _$SurveyQuestionCopyWith(
          _SurveyQuestion value, $Res Function(_SurveyQuestion) _then) =
      __$SurveyQuestionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$Survey {
  ...
  Map<String, dynamic> get responses; // userId -> Map<questionId, answer>
...
extension SurveyPatterns on Survey {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Survey value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _Survey implements Survey {
  const _Survey(
      ...
      final List<String> dismissedBy = const []})
...
// userId -> Map<questionId, answer>
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._dismissedBy, _dismissedBy));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_dismissedBy));
