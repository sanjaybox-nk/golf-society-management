...
@override
int get hashCode => Object.hashAll([runtimeType,isLoading,isSaving,eventId,initialEvent,title,description,imageUrl,eventType,selectedDate,selectedTime,registrationTime,deadlineDate,deadlineTime,selectedSeasonId,isMultiDay,endDate,showRegistrationButton,isInvitational,teeOffInterval,selectedCourseId,courseName,courseDetails,selectedTeeName,selectedFemaleTeeName,dressCode,availableBuggies,maxParticipants,const DeepCollectionEquality().hash(_facilities),const DeepCollectionEquality().hash(_holes),rating,slope,par,selectedTemplateId,eventCompetition,isCustomized,const DeepCollectionEquality().hash(_oomExcludedRoundIds),separateGuests,allowGuests,secondaryTemplateId,secondaryCompetition,isSecondaryCustomized,memberCost,guestCost,societyGreenFee,buggyCost,eventCost,hasBreakfast,hasLunch,hasDinner,breakfastCost,lunchCost,dinnerCost,societyBreakfastCost,societyLunchCost,societyDinnerCost,dinnerLocation,dinnerAddress,showAwards,const DeepCollectionEquality().hash(_awards),const DeepCollectionEquality().hash(_notes),const DeepCollectionEquality().hash(_extraCosts)]);
