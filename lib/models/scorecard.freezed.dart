...
mixin _$Scorecard {
 ...
 String get submittedByUserId; ScorecardStatus get status; ScoringStatus get scoringStatus; List<int?> get holeScores; int? get grossTotal; int? get netTotal; int? get points; AdminEditAudit? get adminEditAudit; bool get adminOverridePublish;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime get updatedAt;
...
@useResult
$Res call({
 String id, String competitionId, String roundId, String entryId, String submittedByUserId, ScorecardStatus status, ScoringStatus scoringStatus, List<int?> holeScores, int? grossTotal, int? netTotal, int? points, AdminEditAudit? adminEditAudit, bool adminOverridePublish,@TimestampConverter() DateTime createdAt,@TimestampConverter() DateTime updatedAt
});
...
/// Create a copy of Scorecard
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? competitionId = null,Object? roundId = null,Object? entryId = null,Object? submittedByUserId = null,Object? status = null,Object? scoringStatus = null,Object? holeScores = null,Object? grossTotal = freezed,Object? netTotal = freezed,Object? points = freezed,Object? adminEditAudit = freezed,Object? adminOverridePublish = null,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
...
as List<int?>,grossTotal: freezed == grossTotal ? _self.grossTotal : grossTotal // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String competitionId,  String roundId,  String entryId,  String submittedByUserId,  ScorecardStatus status,  ScoringStatus scoringStatus,  List<int?> holeScores,  int? grossTotal,  int? netTotal,  int? points,  AdminEditAudit? adminEditAudit,  bool adminOverridePublish, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Scorecard() when $default != null:
return $default(_that.id,_that.competitionId,_that.roundId,_that.entryId,_that.submittedByUserId,_that.status,_that.scoringStatus,_that.holeScores,_that.grossTotal,_that.netTotal,_that.points,_that.adminEditAudit,_that.adminOverridePublish,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String competitionId,  String roundId,  String entryId,  String submittedByUserId,  ScorecardStatus status,  ScoringStatus scoringStatus,  List<int?> holeScores,  int? grossTotal,  int? netTotal,  int? points,  AdminEditAudit? adminEditAudit,  bool adminOverridePublish, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Scorecard():
return $default(_that.id,_that.competitionId,_that.roundId,_that.entryId,_that.submittedByUserId,_that.status,_that.scoringStatus,_that.holeScores,_that.grossTotal,_that.netTotal,_that.points,_that.adminEditAudit,_that.adminOverridePublish,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String competitionId,  String roundId,  String entryId,  String submittedByUserId,  ScorecardStatus status,  ScoringStatus scoringStatus,  List<int?> holeScores,  int? grossTotal,  int? netTotal,  int? points,  AdminEditAudit? adminEditAudit,  bool adminOverridePublish, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Scorecard() when $default != null:
return $default(_that.id,_that.competitionId,_that.roundId,_that.entryId,_that.submittedByUserId,_that.status,_that.scoringStatus,_that.holeScores,_that.grossTotal,_that.netTotal,_that.points,_that.adminEditAudit,_that.adminOverridePublish,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Scorecard extends Scorecard {
  const _Scorecard({required this.id, required this.competitionId, required this.roundId, required this.entryId, required this.submittedByUserId, this.status = ScorecardStatus.draft, this.scoringStatus = ScoringStatus.ok, final  List<int?> holeScores = const [], this.grossTotal, this.netTotal, this.points, this.adminEditAudit, this.adminOverridePublish = false, @TimestampConverter() required this.createdAt, @TimestampConverter() required this.updatedAt}): _holeScores = holeScores,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Scorecard&&(identical(other.id, id) || other.id == id)&&(identical(other.competitionId, competitionId) || other.competitionId == competitionId)&&(identical(other.roundId, roundId) || other.roundId == roundId)&&(identical(other.entryId, entryId) || other.entryId == entryId)&&(identical(other.submittedByUserId, submittedByUserId) || other.submittedByUserId == submittedByUserId)&&(identical(other.status, status) || other.status == status)&&(identical(other.scoringStatus, scoringStatus) || other.scoringStatus == scoringStatus)&&const DeepCollectionEquality().equals(other._holeScores, _holeScores)&&(identical(other.grossTotal, grossTotal) || other.grossTotal == grossTotal)&&(identical(other.netTotal, netTotal) || other.netTotal == netTotal)&&(identical(other.points, points) || other.points == points)&&(identical(other.adminEditAudit, adminEditAudit) || other.adminEditAudit == adminEditAudit)&&(identical(other.adminOverridePublish, adminOverridePublish) || other.adminOverridePublish == adminOverridePublish)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,competitionId,roundId,entryId,submittedByUserId,status,scoringStatus,const DeepCollectionEquality().hash(_holeScores),grossTotal,netTotal,points,adminEditAudit,adminOverridePublish,createdAt,updatedAt);
...
/// Create a copy of Scorecard
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? competitionId = null,Object? roundId = null,Object? entryId = null,Object? submittedByUserId = null,Object? status = null,Object? scoringStatus = null,Object? holeScores = null,Object? grossTotal = freezed,Object? netTotal = freezed,Object? points = freezed,Object? adminEditAudit = freezed,Object? adminOverridePublish = null,Object? createdAt = null,Object? updatedAt = null,}) {
