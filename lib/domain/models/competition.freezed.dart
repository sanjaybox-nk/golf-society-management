...
mixin _$CompetitionRules {
 ...
 TournamentFormat get tournamentFormat; SeedingLogic get seedingLogic; MatchPlayProgression get progressionMode; bool get hasMatchPlayOverlay;// [NEW] Treat Match Play as an overlay feature
 String? get teamAName; String? get teamBName;
...
@useResult
$Res call({
 CompetitionFormat format, CompetitionSubtype subtype, CompetitionMode mode, HandicapMode handicapMode, int handicapCap, double handicapAllowance, int? teamHandicapCap, CompetitionFormat underlyingFormat, bool useCourseAllowance, MaxScoreConfig? maxScoreConfig, PickUpBehaviour pickUpBehaviour, int roundsCount, AggregationMethod aggregation, TieBreakMethod tieBreak, bool holeByHoleRequired, int minDrivesPerPlayer, bool useWHSScrambleAllowance, bool trackShotAttributions, bool applyCapToIndex, int teamBestXCount, int teamSize, bool useMixedTeeAdjustment, TeamHandicapMethod teamHandicapMethod, List<String> oomExcludedRoundIds, TournamentFormat tournamentFormat, SeedingLogic seedingLogic, MatchPlayProgression progressionMode, bool hasMatchPlayOverlay, String? teamAName, String? teamBName
});
...
as MaxScoreConfig?,pickUpBehaviour: null == pickUpBehaviour ? _self.pickUpBehaviour : pickUpBehaviour // ignore: cast_nullable_to_non_nullable
as PickUpBehaviour,roundsCount: null == roundsCount ? _self.roundsCount : roundsCount // ignore: cast_nullable_to_non_nullable
...
as bool,teamAName: freezed == teamAName ? _self.teamAName : teamAName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CompetitionFormat format,  CompetitionSubtype subtype,  CompetitionMode mode,  HandicapMode handicapMode,  int handicapCap,  double handicapAllowance,  int? teamHandicapCap,  CompetitionFormat underlyingFormat,  bool useCourseAllowance,  MaxScoreConfig? maxScoreConfig,  PickUpBehaviour pickUpBehaviour,  int roundsCount,  AggregationMethod aggregation,  TieBreakMethod tieBreak,  bool holeByHoleRequired,  int minDrivesPerPlayer,  bool useWHSScrambleAllowance,  bool trackShotAttributions,  bool applyCapToIndex,  int teamBestXCount,  int teamSize,  bool useMixedTeeAdjustment,  TeamHandicapMethod teamHandicapMethod,  List<String> oomExcludedRoundIds,  TournamentFormat tournamentFormat,  SeedingLogic seedingLogic,  MatchPlayProgression progressionMode,  bool hasMatchPlayOverlay,  String? teamAName,  String? teamBName)  $default,) {final _that = this;
switch (_that) {
case _CompetitionRules():
return $default(_that.format,_that.subtype,_that.mode,_that.handicapMode,_that.handicapCap,_that.handicapAllowance,_that.teamHandicapCap,_that.underlyingFormat,_that.useCourseAllowance,_that.maxScoreConfig,_that.pickUpBehaviour,_that.roundsCount,_that.aggregation,_that.tieBreak,_that.holeByHoleRequired,_that.minDrivesPerPlayer,_that.useWHSScrambleAllowance,_that.trackShotAttributions,_that.applyCapToIndex,_that.teamBestXCount,_that.teamSize,_that.useMixedTeeAdjustment,_that.teamHandicapMethod,_that.oomExcludedRoundIds,_that.tournamentFormat,_that.seedingLogic,_that.progressionMode,_that.hasMatchPlayOverlay,_that.teamAName,_that.teamBName);case _:
  throw StateError('Unexpected subclass');
...
class _CompetitionRules implements CompetitionRules {
  const _CompetitionRules({this.format = CompetitionFormat.stableford, this.subtype = CompetitionSubtype.none, this.mode = CompetitionMode.singles, this.handicapMode = HandicapMode.whs, this.handicapCap = 28, this.handicapAllowance = 1.0, this.teamHandicapCap, this.underlyingFormat = CompetitionFormat.stroke, this.useCourseAllowance = true, this.maxScoreConfig, this.pickUpBehaviour = PickUpBehaviour.maxScore, this.roundsCount = 1, this.aggregation = AggregationMethod.totalSum, this.tieBreak = TieBreakMethod.back9, this.holeByHoleRequired = true, this.minDrivesPerPlayer = 0, this.useWHSScrambleAllowance = true, this.trackShotAttributions = true, this.applyCapToIndex = true, this.teamBestXCount = 2, this.teamSize = 4, this.useMixedTeeAdjustment = false, this.teamHandicapMethod = TeamHandicapMethod.whs, final  List<String> oomExcludedRoundIds = const [], this.tournamentFormat = TournamentFormat.knockout, this.seedingLogic = SeedingLogic.random, this.progressionMode = MatchPlayProgression.bracketed, this.hasMatchPlayOverlay = false, this.teamAName, this.teamBName}): _oomExcludedRoundIds = oomExcludedRoundIds;
...
@override@JsonKey() final  PickUpBehaviour pickUpBehaviour;
...
// [NEW] Treat Match Play as an overlay feature
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,format,subtype,mode,handicapMode,handicapCap,handicapAllowance,teamHandicapCap,underlyingFormat,useCourseAllowance,maxScoreConfig,pickUpBehaviour,roundsCount,aggregation,tieBreak,holeByHoleRequired,minDrivesPerPlayer,useWHSScrambleAllowance,trackShotAttributions,applyCapToIndex,teamBestXCount,teamSize,useMixedTeeAdjustment,teamHandicapMethod,const DeepCollectionEquality().hash(_oomExcludedRoundIds),tournamentFormat,seedingLogic,progressionMode,hasMatchPlayOverlay,teamAName,teamBName]);
