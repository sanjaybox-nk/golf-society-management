...
OrderOfMeritConfig _$OrderOfMeritConfigFromJson(Map<String, dynamic> json) =>
    OrderOfMeritConfig(
      ...
      divisionsEnabled: json['divisionsEnabled'] as bool? ?? false,
...
Map<String, dynamic> _$OrderOfMeritConfigToJson(OrderOfMeritConfig instance) =>
    <String, dynamic>{
      ...
      'groupFilter': instance.groupFilter,
      'divisionsEnabled': instance.divisionsEnabled,
      'runtimeType': instance.$type,
    };

const _$LeaderboardScopeEnumMap = {
  LeaderboardScope.seasonOnly: 'seasonOnly',
  LeaderboardScope.invitationalsOnly: 'invitationalsOnly',
