...
mixin _$CourseConfig {
 ...
 double? get rating; int? get slope; int? get par; String? get selectedTeeName; bool get isGlobal; String? get selectedTeeColor;
...
@useResult
$Res call({
 String name, String address, List<TeeConfig> tees, List<CourseHole> holes, double? rating, int? slope, int? par, String? selectedTeeName, bool isGlobal, String? selectedTeeColor
});
...
/// Create a copy of CourseConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? address = null,Object? tees = null,Object? holes = null,Object? rating = freezed,Object? slope = freezed,Object? par = freezed,Object? selectedTeeName = freezed,Object? isGlobal = null,Object? selectedTeeColor = freezed,}) {
  return _then(_self.copyWith(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
as bool,selectedTeeColor: freezed == selectedTeeColor ? _self.selectedTeeColor : selectedTeeColor // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String address,  List<TeeConfig> tees,  List<CourseHole> holes,  double? rating,  int? slope,  int? par,  String? selectedTeeName,  bool isGlobal,  String? selectedTeeColor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CourseConfig() when $default != null:
return $default(_that.name,_that.address,_that.tees,_that.holes,_that.rating,_that.slope,_that.par,_that.selectedTeeName,_that.isGlobal,_that.selectedTeeColor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String address,  List<TeeConfig> tees,  List<CourseHole> holes,  double? rating,  int? slope,  int? par,  String? selectedTeeName,  bool isGlobal,  String? selectedTeeColor)  $default,) {final _that = this;
switch (_that) {
case _CourseConfig():
return $default(_that.name,_that.address,_that.tees,_that.holes,_that.rating,_that.slope,_that.par,_that.selectedTeeName,_that.isGlobal,_that.selectedTeeColor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String address,  List<TeeConfig> tees,  List<CourseHole> holes,  double? rating,  int? slope,  int? par,  String? selectedTeeName,  bool isGlobal,  String? selectedTeeColor)?  $default,) {final _that = this;
switch (_that) {
case _CourseConfig() when $default != null:
return $default(_that.name,_that.address,_that.tees,_that.holes,_that.rating,_that.slope,_that.par,_that.selectedTeeName,_that.isGlobal,_that.selectedTeeColor);case _:
  return null;
...
class _CourseConfig implements CourseConfig {
  const _CourseConfig({this.name = '', this.address = '', final  List<TeeConfig> tees = const [], final  List<CourseHole> holes = const [], this.rating, this.slope, this.par, this.selectedTeeName, this.isGlobal = true, this.selectedTeeColor}): _tees = tees,_holes = holes;
...
@override final  String? selectedTeeColor;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,address,const DeepCollectionEquality().hash(_tees),const DeepCollectionEquality().hash(_holes),rating,slope,par,selectedTeeName,isGlobal,selectedTeeColor);
...
/// Create a copy of CourseConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? address = null,Object? tees = null,Object? holes = null,Object? rating = freezed,Object? slope = freezed,Object? par = freezed,Object? selectedTeeName = freezed,Object? isGlobal = null,Object? selectedTeeColor = freezed,}) {
