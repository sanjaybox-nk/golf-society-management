...
mixin _$MatchDefinition {
  String get id;
  MatchType get type;
  List<String> get team1Ids; // Player IDs for Side A
  List<String> get team2Ids; // Player IDs for Side B
  Map<String, int>
      get strokesReceived; // Map<PlayerID, Strokes> relative to scratch/lowest
  String? get groupId; // Optional link to TeeGroup
// Bracket / Season Data
  MatchRoundType get round;
  String? get bracketId; // ID of the tournament/bracket
...
// Override Labels (optional)
  ...
  $MatchDefinitionCopyWith<MatchDefinition> get copyWith =>
      _$MatchDefinitionCopyWithImpl<MatchDefinition>(
          this as MatchDefinition, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MatchDefinition &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.type, type) || other.type == type) &&
            const DeepCollectionEquality().equals(other.team1Ids, team1Ids) &&
            const DeepCollectionEquality().equals(other.team2Ids, team2Ids) &&
            const DeepCollectionEquality()
                .equals(other.strokesReceived, strokesReceived) &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            (identical(other.round, round) || other.round == round) &&
            (identical(other.bracketId, bracketId) ||
                other.bracketId == bracketId) &&
            (identical(other.nextMatchId, nextMatchId) ||
                other.nextMatchId == nextMatchId) &&
            (identical(other.bracketOrder, bracketOrder) ||
                other.bracketOrder == bracketOrder) &&
  ...
  int get hashCode => Object.hash(
      ...
      id,
      type,
      const DeepCollectionEquality().hash(team1Ids),
      const DeepCollectionEquality().hash(team2Ids),
      const DeepCollectionEquality().hash(strokesReceived),
      groupId,
      round,
      bracketId,
      nextMatchId,
...
abstract mixin class $MatchDefinitionCopyWith<$Res> {
  factory $MatchDefinitionCopyWith(
          MatchDefinition value, $Res Function(MatchDefinition) _then) =
      _$MatchDefinitionCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      MatchType type,
    ...
    return _then(_self.copyWith(
      ...
      type: null == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as MatchType,
      team1Ids: null == team1Ids
          ? _self.team1Ids
          : team1Ids // ignore: cast_nullable_to_non_nullable
              as List<String>,
      team2Ids: null == team2Ids
          ? _self.team2Ids
          : team2Ids // ignore: cast_nullable_to_non_nullable
              as List<String>,
      ...
      nextMatchId: freezed == nextMatchId
          ...
          : nextMatchId // ignore: cast_nullable_to_non_nullable
              as String?,
      bracketOrder: freezed == bracketOrder
          ? _self.bracketOrder
          : bracketOrder // ignore: cast_nullable_to_non_nullable
              as int?,
...
extension MatchDefinitionPatterns on MatchDefinition {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MatchDefinition value)? $default, {
...
class _MatchDefinition implements MatchDefinition {
  const _MatchDefinition(
      {required this.id,
      required this.type,
      required final List<String> team1Ids,
      required final List<String> team2Ids,
      final Map<String, int> strokesReceived = const {},
      this.groupId,
      ...
      : _team1Ids = team1Ids,
        _team2Ids = team2Ids,
        _strokesReceived = strokesReceived;
  factory _MatchDefinition.fromJson(Map<String, dynamic> json) =>
...
// Player IDs for Side B
  @override
  @JsonKey()
  Map<String, int> get strokesReceived {
...
// e.g., "Team Europe" or "Names calculated"
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MatchDefinitionCopyWith<_MatchDefinition> get copyWith =>
      __$MatchDefinitionCopyWithImpl<_MatchDefinition>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MatchDefinitionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MatchDefinition &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.type, type) || other.type == type) &&
            const DeepCollectionEquality().equals(other._team1Ids, _team1Ids) &&
            const DeepCollectionEquality().equals(other._team2Ids, _team2Ids) &&
            const DeepCollectionEquality()
                .equals(other._strokesReceived, _strokesReceived) &&
            (identical(other.groupId, groupId) || other.groupId == groupId) &&
            (identical(other.round, round) || other.round == round) &&
            (identical(other.bracketId, bracketId) ||
                other.bracketId == bracketId) &&
  ...
  int get hashCode => Object.hash(
      ...
      id,
      type,
      const DeepCollectionEquality().hash(_team1Ids),
      const DeepCollectionEquality().hash(_team2Ids),
      const DeepCollectionEquality().hash(_strokesReceived),
      groupId,
      round,
      bracketId,
      nextMatchId,
...
/// @nodoc
abstract mixin class _$MatchDefinitionCopyWith<$Res>
    implements $MatchDefinitionCopyWith<$Res> {
  factory _$MatchDefinitionCopyWith(
          _MatchDefinition value, $Res Function(_MatchDefinition) _then) =
      __$MatchDefinitionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$MatchResult {
  String get matchId;
  int get winningTeamIndex; // 0 = Team 1, 1 = Team 2, -1 = Halve/Draw
  String get status; // Display string: "3&2", "1UP", "A/S"
  int get score; // Positive = Team 1 UP, Negative = Team 2 UP
  List<int>
      get holeResults; // 1 = T1 Win, -1 = T2 Win, 0 = Halve, null = Not Played
  int get holesPlayed;
  bool get isFinal;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.winningTeamIndex, winningTeamIndex) ||
                other.winningTeamIndex == winningTeamIndex) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.score, score) || other.score == score) &&
            const DeepCollectionEquality()
                .equals(other.holeResults, holeResults) &&
  ...
  int get hashCode => Object.hash(
      ...
      status,
      score,
      const DeepCollectionEquality().hash(holeResults),
      holesPlayed,
      isFinal);
...
class _$MatchResultCopyWithImpl<$Res> implements $MatchResultCopyWith<$Res> {
  ...
  $Res call({
    Object? matchId = null,
    Object? winningTeamIndex = null,
    Object? status = null,
    Object? score = null,
    Object? holeResults = null,
    ...
    return _then(_self.copyWith(
      matchId: null == matchId
          ...
          : matchId // ignore: cast_nullable_to_non_nullable
              as String,
      winningTeamIndex: null == winningTeamIndex
          ? _self.winningTeamIndex
          : winningTeamIndex // ignore: cast_nullable_to_non_nullable
              as int,
      status: null == status
          ? _self.status
      ...
      score: null == score
          ...
          : score // ignore: cast_nullable_to_non_nullable
              as int,
      holeResults: null == holeResults
          ? _self.holeResults
          : holeResults // ignore: cast_nullable_to_non_nullable
              as List<int>,
...
extension MatchResultPatterns on MatchResult {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String matchId, int winningTeamIndex, String status,
            int score, List<int> holeResults, int holesPlayed, bool isFinal)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _MatchResult() when $default != null:
        return $default(_that.matchId, _that.winningTeamIndex, _that.status,
            _that.score, _that.holeResults, _that.holesPlayed, _that.isFinal);
      case _:
        return orElse();
    }
  }
...
class _MatchResult implements MatchResult {
  const _MatchResult(
      ...
      required this.score,
      required final List<int> holeResults,
      required this.holesPlayed,
      this.isFinal = false})
      : _holeResults = holeResults;
...
// 1 = T1 Win, -1 = T2 Win, 0 = Halve, null = Not Played
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.score, score) || other.score == score) &&
            const DeepCollectionEquality()
                .equals(other._holeResults, _holeResults) &&
            (identical(other.holesPlayed, holesPlayed) ||
                other.holesPlayed == holesPlayed) &&
            (identical(other.isFinal, isFinal) || other.isFinal == isFinal));
  }
  ...
  int get hashCode => Object.hash(
      ...
      status,
      score,
      const DeepCollectionEquality().hash(_holeResults),
      holesPlayed,
      isFinal);
