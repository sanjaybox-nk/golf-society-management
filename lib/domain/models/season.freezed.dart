...
mixin _$Season {
  ...
  bool get isCurrent;
  List<LeaderboardConfig> get leaderboards;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.leaderboards, leaderboards) &&
  ...
  int get hashCode => Object.hash(
      ...
      status,
      isCurrent,
      const DeepCollectionEquality().hash(leaderboards),
      const DeepCollectionEquality().hash(agmData));
    ...
    return _then(_self.copyWith(
      ...
      leaderboards: null == leaderboards
          ...
          : leaderboards // ignore: cast_nullable_to_non_nullable
              as List<LeaderboardConfig>,
      agmData: null == agmData
          ? _self.agmData
          : agmData // ignore: cast_nullable_to_non_nullable
...
class _Season extends Season {
  const _Season(
      ...
      final List<LeaderboardConfig> leaderboards = const [],
      final Map<String, dynamic> agmData = const {}})
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_agmData));
