...
_SocietyConfig _$SocietyConfigFromJson(
  ...
  textPrimaryColor: (json['textPrimaryColor'] as num?)?.toInt() ?? 0xFF1A1A1A,
  textSecondaryColor:
  ...
  scoreBirdieColor: (json['scoreBirdieColor'] as num?)?.toInt() ?? 0xFF4ADE80,
  scoreParColor: (json['scoreParColor'] as num?)?.toInt() ?? 0xFFA0A0A0,
  scoreBogeyColor: (json['scoreBogeyColor'] as num?)?.toInt() ?? 0xFFFF745C,
  scoreDoubleColor: (json['scoreDoubleColor'] as num?)?.toInt() ?? 0xFFFF5533,
  ...
  navBarRadius: (json['navBarRadius'] as num?)?.toDouble() ?? 20.0,
  tabIndicatorRadius: (json['tabIndicatorRadius'] as num?)?.toDouble() ?? 8.0,
  ...
  buttonSmallHeight: (json['buttonSmallHeight'] as num?)?.toDouble() ?? 32.0,
  buttonHorizontalPadding:
      (json['buttonHorizontalPadding'] as num?)?.toDouble() ?? 24.0,
  sliderTrackHeight: (json['sliderTrackHeight'] as num?)?.toDouble() ?? 4.0,
  sliderThumbRadius: (json['sliderThumbRadius'] as num?)?.toDouble() ?? 10.0,
  dividerThickness: (json['dividerThickness'] as num?)?.toDouble() ?? 1.0,
  surfaceHeightLarge: (json['surfaceHeightLarge'] as num?)?.toDouble() ?? 60.0,
  surfaceHeightMedium:
  ...
  societyCutEventLimit: (json['societyCutEventLimit'] as num?)?.toInt() ?? 0,
  societyCutCountPlayedOnly: json['societyCutCountPlayedOnly'] as bool? ?? true,
...
Map<String, dynamic> _$SocietyConfigToJson(_SocietyConfig instance) =>
    <String, dynamic>{
      ...
      'navBarRadius': instance.navBarRadius,
      'tabIndicatorRadius': instance.tabIndicatorRadius,
