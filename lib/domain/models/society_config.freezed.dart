...
@OptionalTimestampConverter() DateTime? get renewalPaymentDeadline;// [NEW] Adjustable payment limit
 ...
 bool get enableGimmes; bool get enableSocialMembership; double get socialMemberFee;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,societyName,logoUrl,primaryColor,secondaryColor,tertiaryColor,dangerousColor,backgroundColor,cardColor,surfaceElevatedColor,textPrimaryColor,textSecondaryColor,textMutedColor,scoreEagleColor,scoreBirdieColor,scoreParColor,scoreBogeyColor,scoreDoubleColor,scoreTriplePlusColor,teamAColor,teamBColor,statusPublishedColor,statusConfirmedColor,statusReservedColor,statusWaitlistColor,statusWithdrawnColor,statusDinnerColor,cardRadius,inputRadius,useShadows,shadowIntensity,useBorders,borderWidth,pillRadius,buttonRadius,borderColor,dividerColor,heroRadius,accentRadius,navBarRadius,tabIndicatorRadius,accentOpacity,shadowSpread,shadowOpacity,labelToCardSpacing,cardToLabelSpacing,fieldToFieldSpacing,cardToCardSpacing,cardVerticalPadding,cardHorizontalPadding,tabToContentSpacing,groupFooterToLabelSpacing,iconBadgeFillColor,iconBadgeIconColor,iconBadgeOpacity,iconOpacity,iconBadgeSize,iconBadgeIconSize,buttonHeight,buttonSmallHeight,buttonHorizontalPadding,sliderTrackHeight,sliderThumbRadius,dividerThickness,surfaceHeightLarge,surfaceHeightMedium,fontFamily,themeMode,const DeepCollectionEquality().hash(_customColors),cardTintIntensity,useCardGradient,currencySymbol,currencyCode,groupingStrategy,useWhsHandicaps,distanceUnit,handicapSystem,selectedPaletteName,separateGuestLeaderboard,societyCutMode,const DeepCollectionEquality().hash(_societyCutRules),societyCutEventLimit,societyCutCountPlayedOnly,societyCutFilterSeason,societyCutFilterInvitational,globalMarkupPercentage,guestMarkupExtra,showMatchPlayOverlay,globalMembershipEndDate,renewalWindowDays,isRenewalActive,renewalLaunchDate,renewalDeadline,renewalPaymentDeadline,startingBalance,const DeepCollectionEquality().hash(_ledgerEntries),const DeepCollectionEquality().hash(_sponsors),pointsColor,heroGradientColor,heroGradientColorSecondary,heroGradientOpacity,heroTextColor,cardTintColor,iconBadgeTextColor,enablePenaltyFines,penaltyFineAmount,nrFineAmount,enableGimmes,enableSocialMembership,socialMemberFee]);
