...
mixin _$ProcessedPlayerScore {
 ...
 String get playerId; String get playerName; bool get isGuest; double get handicapIndex; double get courseHandicap; int get playingHandicap; double get appliedSocietyCut; String get teeName; List<int?> get holeScores; ScoringResult get result; String? get tieBreakLabel; String? get thruLabel; ScoringStatus get scoringStatus;
...
@useResult
$Res call({
 String playerId, String playerName, bool isGuest, double handicapIndex, double courseHandicap, int playingHandicap, double appliedSocietyCut, String teeName, List<int?> holeScores, ScoringResult result, String? tieBreakLabel, String? thruLabel, ScoringStatus scoringStatus
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String playerId,  String playerName,  bool isGuest,  double handicapIndex,  double courseHandicap,  int playingHandicap,  double appliedSocietyCut,  String teeName,  List<int?> holeScores,  ScoringResult result,  String? tieBreakLabel,  String? thruLabel,  ScoringStatus scoringStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProcessedPlayerScore() when $default != null:
return $default(_that.playerId,_that.playerName,_that.isGuest,_that.handicapIndex,_that.courseHandicap,_that.playingHandicap,_that.appliedSocietyCut,_that.teeName,_that.holeScores,_that.result,_that.tieBreakLabel,_that.thruLabel,_that.scoringStatus);case _:
  return orElse();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProcessedPlayerScore&&(identical(other.playerId, playerId) || other.playerId == playerId)&&(identical(other.playerName, playerName) || other.playerName == playerName)&&(identical(other.isGuest, isGuest) || other.isGuest == isGuest)&&(identical(other.handicapIndex, handicapIndex) || other.handicapIndex == handicapIndex)&&(identical(other.courseHandicap, courseHandicap) || other.courseHandicap == courseHandicap)&&(identical(other.playingHandicap, playingHandicap) || other.playingHandicap == playingHandicap)&&(identical(other.appliedSocietyCut, appliedSocietyCut) || other.appliedSocietyCut == appliedSocietyCut)&&(identical(other.teeName, teeName) || other.teeName == teeName)&&const DeepCollectionEquality().equals(other._holeScores, _holeScores)&&(identical(other.result, result) || other.result == result)&&(identical(other.tieBreakLabel, tieBreakLabel) || other.tieBreakLabel == tieBreakLabel)&&(identical(other.thruLabel, thruLabel) || other.thruLabel == thruLabel)&&(identical(other.scoringStatus, scoringStatus) || other.scoringStatus == scoringStatus));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,playerId,playerName,isGuest,handicapIndex,courseHandicap,playingHandicap,appliedSocietyCut,teeName,const DeepCollectionEquality().hash(_holeScores),result,tieBreakLabel,thruLabel,scoringStatus);
...
mixin _$ProcessedGroupResult {
 ...
 int get groupIndex; String get label; int get totalScore; List<int> get tieBreakMetrics;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupIndex,label,totalScore,const DeepCollectionEquality().hash(tieBreakMetrics));
...
@useResult
$Res call({
 int groupIndex, String label, int totalScore, List<int> tieBreakMetrics
});
...
/// Create a copy of ProcessedGroupResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupIndex = null,Object? label = null,Object? totalScore = null,Object? tieBreakMetrics = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int groupIndex,  String label,  int totalScore,  List<int> tieBreakMetrics)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProcessedGroupResult() when $default != null:
return $default(_that.groupIndex,_that.label,_that.totalScore,_that.tieBreakMetrics);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int groupIndex,  String label,  int totalScore,  List<int> tieBreakMetrics)  $default,) {final _that = this;
switch (_that) {
case _ProcessedGroupResult():
return $default(_that.groupIndex,_that.label,_that.totalScore,_that.tieBreakMetrics);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int groupIndex,  String label,  int totalScore,  List<int> tieBreakMetrics)?  $default,) {final _that = this;
switch (_that) {
case _ProcessedGroupResult() when $default != null:
return $default(_that.groupIndex,_that.label,_that.totalScore,_that.tieBreakMetrics);case _:
  return null;
...
class _ProcessedGroupResult implements ProcessedGroupResult {
  const _ProcessedGroupResult({required this.groupIndex, required this.label, required this.totalScore, required final  List<int> tieBreakMetrics}): _tieBreakMetrics = tieBreakMetrics;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupIndex,label,totalScore,const DeepCollectionEquality().hash(_tieBreakMetrics));
...
/// Create a copy of ProcessedGroupResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupIndex = null,Object? label = null,Object? totalScore = null,Object? tieBreakMetrics = null,}) {
...
@useResult
$Res call({
 String entryId, String playerName, int score, String scoreLabel, int holesPlayed, bool isGuest, List<String> teamMemberIds, List<String> teamMemberNames, List<int> individualPlayingHandicaps, List<int?> holeNetScores, List<List<int?>>? individualHoleScores, List<List<int?>>? individualHoleNetScores, List<List<int?>>? individualHolePoints, List<int?>? holeScores, List<int?>? holePoints, bool hasSocietyCut, int position, List<int> tieBreakMetrics, ScoringStatus scoringStatus, double? handicapIndex, String? tieBreakLabel
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String entryId,  String playerName,  int score,  String scoreLabel,  int holesPlayed,  bool isGuest,  List<String> teamMemberIds,  List<String> teamMemberNames,  List<int> individualPlayingHandicaps,  List<int?> holeNetScores,  List<List<int?>>? individualHoleScores,  List<List<int?>>? individualHoleNetScores,  List<List<int?>>? individualHolePoints,  List<int?>? holeScores,  List<int?>? holePoints,  bool hasSocietyCut,  int position,  List<int> tieBreakMetrics,  ScoringStatus scoringStatus,  double? handicapIndex,  String? tieBreakLabel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProcessedLeaderboardEntry() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String entryId,  String playerName,  int score,  String scoreLabel,  int holesPlayed,  bool isGuest,  List<String> teamMemberIds,  List<String> teamMemberNames,  List<int> individualPlayingHandicaps,  List<int?> holeNetScores,  List<List<int?>>? individualHoleScores,  List<List<int?>>? individualHoleNetScores,  List<List<int?>>? individualHolePoints,  List<int?>? holeScores,  List<int?>? holePoints,  bool hasSocietyCut,  int position,  List<int> tieBreakMetrics,  ScoringStatus scoringStatus,  double? handicapIndex,  String? tieBreakLabel)  $default,) {final _that = this;
switch (_that) {
case _ProcessedLeaderboardEntry():
return $default(_that.entryId,_that.playerName,_that.score,_that.scoreLabel,_that.holesPlayed,_that.isGuest,_that.teamMemberIds,_that.teamMemberNames,_that.individualPlayingHandicaps,_that.holeNetScores,_that.individualHoleScores,_that.individualHoleNetScores,_that.individualHolePoints,_that.holeScores,_that.holePoints,_that.hasSocietyCut,_that.position,_that.tieBreakMetrics,_that.scoringStatus,_that.handicapIndex,_that.tieBreakLabel);case _:
  throw StateError('Unexpected subclass');
...
mixin _$ProcessedEventData {
 ...
 String get eventId; List<ProcessedPlayerScore> get individualScores; List<ProcessedLeaderboardEntry> get leaderboard; List<ProcessedGroupResult> get groupRankings; Map<String, dynamic> get eventStats; List<int> get holePars; int get computeVersion; DateTime get lastComputedAt;
...
@useResult
$Res call({
 String eventId, List<ProcessedPlayerScore> individualScores, List<ProcessedLeaderboardEntry> leaderboard, List<ProcessedGroupResult> groupRankings, Map<String, dynamic> eventStats, List<int> holePars, int computeVersion, DateTime lastComputedAt
});
...
/// Create a copy of ProcessedEventData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eventId = null,Object? individualScores = null,Object? leaderboard = null,Object? groupRankings = null,Object? eventStats = null,Object? holePars = null,Object? computeVersion = null,Object? lastComputedAt = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  List<ProcessedPlayerScore> individualScores,  List<ProcessedLeaderboardEntry> leaderboard,  List<ProcessedGroupResult> groupRankings,  Map<String, dynamic> eventStats,  List<int> holePars,  int computeVersion,  DateTime lastComputedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProcessedEventData() when $default != null:
return $default(_that.eventId,_that.individualScores,_that.leaderboard,_that.groupRankings,_that.eventStats,_that.holePars,_that.computeVersion,_that.lastComputedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eventId,  List<ProcessedPlayerScore> individualScores,  List<ProcessedLeaderboardEntry> leaderboard,  List<ProcessedGroupResult> groupRankings,  Map<String, dynamic> eventStats,  List<int> holePars,  int computeVersion,  DateTime lastComputedAt)  $default,) {final _that = this;
switch (_that) {
case _ProcessedEventData():
return $default(_that.eventId,_that.individualScores,_that.leaderboard,_that.groupRankings,_that.eventStats,_that.holePars,_that.computeVersion,_that.lastComputedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eventId,  List<ProcessedPlayerScore> individualScores,  List<ProcessedLeaderboardEntry> leaderboard,  List<ProcessedGroupResult> groupRankings,  Map<String, dynamic> eventStats,  List<int> holePars,  int computeVersion,  DateTime lastComputedAt)?  $default,) {final _that = this;
switch (_that) {
case _ProcessedEventData() when $default != null:
return $default(_that.eventId,_that.individualScores,_that.leaderboard,_that.groupRankings,_that.eventStats,_that.holePars,_that.computeVersion,_that.lastComputedAt);case _:
  return null;
...
class _ProcessedEventData implements ProcessedEventData {
  const _ProcessedEventData({required this.eventId, required final  List<ProcessedPlayerScore> individualScores, required final  List<ProcessedLeaderboardEntry> leaderboard, required final  List<ProcessedGroupResult> groupRankings, required final  Map<String, dynamic> eventStats, required final  List<int> holePars, this.computeVersion = 0, required this.lastComputedAt}): _individualScores = individualScores,_leaderboard = leaderboard,_groupRankings = groupRankings,_eventStats = eventStats,_holePars = holePars;
...
/// Create a copy of ProcessedEventData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventId = null,Object? individualScores = null,Object? leaderboard = null,Object? groupRankings = null,Object? eventStats = null,Object? holePars = null,Object? computeVersion = null,Object? lastComputedAt = null,}) {
