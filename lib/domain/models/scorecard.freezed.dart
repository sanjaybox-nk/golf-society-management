...
mixin _$AdminEditAudit {
  ...
  $AdminEditAuditCopyWith<AdminEditAudit> get copyWith =>
      _$AdminEditAuditCopyWithImpl<AdminEditAudit>(
          this as AdminEditAudit, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminEditAudit &&
            (identical(other.overridden, overridden) ||
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, overridden, reason, editorId, timestamp);
...
abstract mixin class $AdminEditAuditCopyWith<$Res> {
  factory $AdminEditAuditCopyWith(
          AdminEditAudit value, $Res Function(AdminEditAudit) _then) =
      _$AdminEditAuditCopyWithImpl;
  @useResult
  $Res call(
      {bool overridden,
      String reason,
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      overridden: null == overridden
          ? _self.overridden
          : overridden // ignore: cast_nullable_to_non_nullable
              as bool,
      reason: null == reason
          ? _self.reason
...
extension AdminEditAuditPatterns on AdminEditAudit {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminEditAudit value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool overridden, String reason, String editorId,
            @TimestampConverter() DateTime timestamp)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AdminEditAudit() when $default != null:
        return $default(
            _that.overridden, _that.reason, _that.editorId, _that.timestamp);
      case _:
        return orElse();
    }
  }
...
class _AdminEditAudit implements AdminEditAudit {
  const _AdminEditAudit(
      {required this.overridden,
      required this.reason,
      required this.editorId,
      @TimestampConverter() required this.timestamp});
  factory _AdminEditAudit.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminEditAuditCopyWith<_AdminEditAudit> get copyWith =>
      __$AdminEditAuditCopyWithImpl<_AdminEditAudit>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminEditAuditToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdminEditAuditCopyWith<$Res>
    implements $AdminEditAuditCopyWith<$Res> {
  factory _$AdminEditAuditCopyWith(
          _AdminEditAudit value, $Res Function(_AdminEditAudit) _then) =
      __$AdminEditAuditCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool overridden,
...
mixin _$Scorecard {
  ...
  String get roundId;
  String get entryId; // memberId or teamId
  String get submittedByUserId;
  ScorecardStatus get status;
  ScoringStatus get scoringStatus;
  List<int?> get holeScores;
  List<int?> get playerVerifierScores;
  String? get markerId;
  Map<int, String?>
      get shotAttributions; // [NEW] Hole index -> Member ID of chosen shot (for Florida)
  int? get grossTotal;
  int? get netTotal;
  int? get points;
  ...
  $ScorecardCopyWith<Scorecard> get copyWith =>
      _$ScorecardCopyWithImpl<Scorecard>(this as Scorecard, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.playerVerifierScores, playerVerifierScores) &&
            (identical(other.markerId, markerId) ||
                other.markerId == markerId) &&
            const DeepCollectionEquality()
                .equals(other.shotAttributions, shotAttributions) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(playerVerifierScores),
        markerId,
        const DeepCollectionEquality().hash(shotAttributions),
        grossTotal,
        netTotal,
        points,
        handicapIndex,
...
abstract mixin class $ScorecardCopyWith<$Res> {
  factory $ScorecardCopyWith(Scorecard value, $Res Function(Scorecard) _then) =
      _$ScorecardCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      ...
      List<int?> holeScores,
      List<int?> playerVerifierScores,
      String? markerId,
      Map<int, String?> shotAttributions,
      int? grossTotal,
      int? netTotal,
      int? points,
...
/// @nodoc
class _$ScorecardCopyWithImpl<$Res> implements $ScorecardCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? roundId = null,
    Object? entryId = null,
    Object? submittedByUserId = null,
    Object? status = null,
    Object? scoringStatus = null,
    Object? holeScores = null,
    Object? playerVerifierScores = null,
    Object? markerId = freezed,
    Object? shotAttributions = null,
    ...
    return _then(_self.copyWith(
      ...
      holeScores: null == holeScores
          ...
          : holeScores // ignore: cast_nullable_to_non_nullable
              as List<int?>,
      playerVerifierScores: null == playerVerifierScores
          ? _self.playerVerifierScores
          : playerVerifierScores // ignore: cast_nullable_to_non_nullable
              as List<int?>,
      markerId: freezed == markerId
          ? _self.markerId
          : markerId // ignore: cast_nullable_to_non_nullable
              as String?,
      shotAttributions: null == shotAttributions
          ? _self.shotAttributions
          : shotAttributions // ignore: cast_nullable_to_non_nullable
              as Map<int, String?>,
      ...
      adminEditAudit: freezed == adminEditAudit
          ...
          : adminEditAudit // ignore: cast_nullable_to_non_nullable
              as AdminEditAudit?,
      adminOverridePublish: null == adminOverridePublish
          ? _self.adminOverridePublish
          : adminOverridePublish // ignore: cast_nullable_to_non_nullable
              as bool,
...
extension ScorecardPatterns on Scorecard {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Scorecard value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
    ...
    switch (_that) {
      case _Scorecard() when $default != null:
        return $default(
            ...
            _that.roundId,
            _that.entryId,
            _that.submittedByUserId,
            _that.status,
            _that.scoringStatus,
            _that.holeScores,
            _that.playerVerifierScores,
            _that.markerId,
            _that.shotAttributions,
            _that.grossTotal,
            _that.netTotal,
            _that.points,
            _that.handicapIndex,
...
class _Scorecard extends Scorecard {
  const _Scorecard(
      ...
      final List<int?> holeScores = const [],
      final List<int?> playerVerifierScores = const [],
      this.markerId,
      final Map<int, String?> shotAttributions = const {},
      this.grossTotal,
      this.netTotal,
      this.points,
      this.handicapIndex,
      ...
      : _holeScores = holeScores,
        _playerVerifierScores = playerVerifierScores,
        _shotAttributions = shotAttributions,
        super._();
  factory _Scorecard.fromJson(Map<String, dynamic> json) =>
...
// memberId or teamId
  ...
  @JsonKey()
  List<int?> get playerVerifierScores {
    if (_playerVerifierScores is EqualUnmodifiableListView)
      return _playerVerifierScores;
    // ignore: implicit_dynamic_type
  ...
  @override
  @JsonKey()
  Map<int, String?> get shotAttributions {
...
// [NEW] Hole index -> Member ID of chosen shot (for Florida)
  ...
  @override
  @JsonKey()
  final bool adminOverridePublish;
  @override
  @TimestampConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScorecardCopyWith<_Scorecard> get copyWith =>
      __$ScorecardCopyWithImpl<_Scorecard>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ScorecardToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._playerVerifierScores, _playerVerifierScores) &&
            (identical(other.markerId, markerId) ||
                other.markerId == markerId) &&
            const DeepCollectionEquality()
                .equals(other._shotAttributions, _shotAttributions) &&
            (identical(other.grossTotal, grossTotal) ||
                other.grossTotal == grossTotal) &&
            (identical(other.netTotal, netTotal) ||
                other.netTotal == netTotal) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(_playerVerifierScores),
        markerId,
        const DeepCollectionEquality().hash(_shotAttributions),
        grossTotal,
        netTotal,
        points,
        handicapIndex,
...
/// @nodoc
abstract mixin class _$ScorecardCopyWith<$Res>
    implements $ScorecardCopyWith<$Res> {
  factory _$ScorecardCopyWith(
          _Scorecard value, $Res Function(_Scorecard) _then) =
      __$ScorecardCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$ScorecardCopyWithImpl<$Res> implements _$ScorecardCopyWith<$Res> {
