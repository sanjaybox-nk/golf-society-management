...
mixin _$SocietyConfig {
 ...
 bool get includeGuestsInLeaderboard;// [NEW] Global default for guest leaderboard inclusion
 bool get separateGuestLeaderboard;// Separate Guests from Members in Standings
...
@useResult
$Res call({
 String societyName, String? logoUrl, int primaryColor, String themeMode, List<int> customColors, double cardTintIntensity, bool useCardGradient, String currencySymbol, String currencyCode, String groupingStrategy, bool useWhsHandicaps, String distanceUnit, HandicapSystem handicapSystem, String? selectedPaletteName, bool includeGuestsInLeaderboard, bool separateGuestLeaderboard, bool enableSocietyCuts, Map<String, double> societyCutRules
});
...
as String?,includeGuestsInLeaderboard: null == includeGuestsInLeaderboard ? _self.includeGuestsInLeaderboard : includeGuestsInLeaderboard // ignore: cast_nullable_to_non_nullable
as bool,separateGuestLeaderboard: null == separateGuestLeaderboard ? _self.separateGuestLeaderboard : separateGuestLeaderboard // ignore: cast_nullable_to_non_nullable
as bool,enableSocietyCuts: null == enableSocietyCuts ? _self.enableSocietyCuts : enableSocietyCuts // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String societyName,  String? logoUrl,  int primaryColor,  String themeMode,  List<int> customColors,  double cardTintIntensity,  bool useCardGradient,  String currencySymbol,  String currencyCode,  String groupingStrategy,  bool useWhsHandicaps,  String distanceUnit,  HandicapSystem handicapSystem,  String? selectedPaletteName,  bool includeGuestsInLeaderboard,  bool separateGuestLeaderboard,  bool enableSocietyCuts,  Map<String, double> societyCutRules)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SocietyConfig() when $default != null:
return $default(_that.societyName,_that.logoUrl,_that.primaryColor,_that.themeMode,_that.customColors,_that.cardTintIntensity,_that.useCardGradient,_that.currencySymbol,_that.currencyCode,_that.groupingStrategy,_that.useWhsHandicaps,_that.distanceUnit,_that.handicapSystem,_that.selectedPaletteName,_that.includeGuestsInLeaderboard,_that.separateGuestLeaderboard,_that.enableSocietyCuts,_that.societyCutRules);case _:
  return orElse();
...
@override@JsonKey() final  bool includeGuestsInLeaderboard;
// [NEW] Global default for guest leaderboard inclusion
@override@JsonKey() final  bool separateGuestLeaderboard;
// Separate Guests from Members in Standings
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,societyName,logoUrl,primaryColor,themeMode,const DeepCollectionEquality().hash(_customColors),cardTintIntensity,useCardGradient,currencySymbol,currencyCode,groupingStrategy,useWhsHandicaps,distanceUnit,handicapSystem,selectedPaletteName,includeGuestsInLeaderboard,separateGuestLeaderboard,enableSocietyCuts,const DeepCollectionEquality().hash(_societyCutRules));
