...
_ProcessedLeaderboardEntry _$ProcessedLeaderboardEntryFromJson(
    ...
    _ProcessedLeaderboardEntry(
      ...
      individualHoleScores: (json['individualHoleScores'] as List<dynamic>?)
          ...
          .toList(),
      individualHoleNetScores: (json['individualHoleNetScores']
              as List<dynamic>?)
          ?.map((e) =>
              (e as List<dynamic>).map((e) => (e as num?)?.toInt()).toList())
          .toList(),
...
Map<String, dynamic> _$ProcessedEventDataToJson(_ProcessedEventData instance) =>
    <String, dynamic>{
      'eventId': instance.eventId,
      'individualScores':
          instance.individualScores.map((e) => e.toJson()).toList(),
