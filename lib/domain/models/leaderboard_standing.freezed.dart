...
mixin _$LeaderboardStanding {
  ...
  String get memberId; // Basic Info
  String get memberName;
  String? get avatarUrl;
  double get currentHandicap; // Metrics
  double
      get points; // Primary sorting metric (OOM points, Stableford total, etc.)
  int get roundsPlayed;
  int get roundsCounted; // For 'Best N'
// Detailed Data (Optional, based on type)
  ...
  $LeaderboardStandingCopyWith<LeaderboardStanding> get copyWith =>
      _$LeaderboardStandingCopyWithImpl<LeaderboardStanding>(
          this as LeaderboardStanding, _$identity);
...
abstract mixin class $LeaderboardStandingCopyWith<$Res> {
  factory $LeaderboardStandingCopyWith(
          LeaderboardStanding value, $Res Function(LeaderboardStanding) _then) =
      _$LeaderboardStandingCopyWithImpl;
  @useResult
  $Res call(
    ...
    return _then(_self.copyWith(
      ...
      roundsPlayed: null == roundsPlayed
          ...
          : roundsPlayed // ignore: cast_nullable_to_non_nullable
              as int,
      roundsCounted: null == roundsCounted
          ? _self.roundsCounted
...
extension LeaderboardStandingPatterns on LeaderboardStanding {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LeaderboardStanding value)? $default, {
...
class _LeaderboardStanding extends LeaderboardStanding {
  const _LeaderboardStanding(
      ...
      required this.roundsCounted,
      final List<double> history = const [],
      final Map<String, int> holeScores = const {},
      final Map<String, int> stats = const {}})
      : _history = history,
        _holeScores = holeScores,
        _stats = stats,
        super._();
  factory _LeaderboardStanding.fromJson(Map<String, dynamic> json) =>
...
// For Eclectic (1-18)
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LeaderboardStandingCopyWith<_LeaderboardStanding> get copyWith =>
      __$LeaderboardStandingCopyWithImpl<_LeaderboardStanding>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LeaderboardStandingToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$LeaderboardStandingCopyWith<$Res>
    implements $LeaderboardStandingCopyWith<$Res> {
  factory _$LeaderboardStandingCopyWith(_LeaderboardStanding value,
          $Res Function(_LeaderboardStanding) _then) =
      __$LeaderboardStandingCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String leaderboardId,
