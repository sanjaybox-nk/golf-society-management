...
/// @nodoc
mixin _$EventExtraCost {

 String get id; String get label; double get amount;
/// Create a copy of EventExtraCost
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EventExtraCostCopyWith<EventExtraCost> get copyWith => _$EventExtraCostCopyWithImpl<EventExtraCost>(this as EventExtraCost, _$identity);

  /// Serializes this EventExtraCost to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EventExtraCost&&(identical(other.id, id) || other.id == id)&&(identical(other.label, label) || other.label == label)&&(identical(other.amount, amount) || other.amount == amount));
}
...
@override
String toString() {
  return 'EventExtraCost(id: $id, label: $label, amount: $amount)';
}
...
/// @nodoc
abstract mixin class $EventExtraCostCopyWith<$Res>  {
  factory $EventExtraCostCopyWith(EventExtraCost value, $Res Function(EventExtraCost) _then) = _$EventExtraCostCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$EventExtraCostCopyWithImpl<$Res>
    implements $EventExtraCostCopyWith<$Res> {
  _$EventExtraCostCopyWithImpl(this._self, this._then);

  final EventExtraCost _self;
  final $Res Function(EventExtraCost) _then;
...
/// Adds pattern-matching-related methods to [EventExtraCost].
extension EventExtraCostPatterns on EventExtraCost {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EventExtraCost value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EventExtraCost() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EventExtraCost value)  $default,){
final _that = this;
switch (_that) {
case _EventExtraCost():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EventExtraCost value)?  $default,){
final _that = this;
switch (_that) {
case _EventExtraCost() when $default != null:
return $default(_that);case _:
...
class _EventExtraCost implements EventExtraCost {
  const _EventExtraCost({required this.id, required this.label, required this.amount});
  factory _EventExtraCost.fromJson(Map<String, dynamic> json) => _$EventExtraCostFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$EventExtraCostCopyWith<_EventExtraCost> get copyWith => __$EventExtraCostCopyWithImpl<_EventExtraCost>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EventExtraCostToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EventExtraCost&&(identical(other.id, id) || other.id == id)&&(identical(other.label, label) || other.label == label)&&(identical(other.amount, amount) || other.amount == amount));
}
...
/// @nodoc
abstract mixin class _$EventExtraCostCopyWith<$Res> implements $EventExtraCostCopyWith<$Res> {
  factory _$EventExtraCostCopyWith(_EventExtraCost value, $Res Function(_EventExtraCost) _then) = __$EventExtraCostCopyWithImpl;
@override @useResult
$Res call({
 String id, String label, double amount
});
...
/// @nodoc
class __$EventExtraCostCopyWithImpl<$Res>
    implements _$EventExtraCostCopyWith<$Res> {
  __$EventExtraCostCopyWithImpl(this._self, this._then);

  final _EventExtraCost _self;
  final $Res Function(_EventExtraCost) _then;

/// Create a copy of EventExtraCost
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? label = null,Object? amount = null,}) {
  return _then(_EventExtraCost(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,label: null == label ? _self.label : label // ignore: cast_nullable_to_non_nullable
as String,amount: null == amount ? _self.amount : amount // ignore: cast_nullable_to_non_nullable
as double,
...
mixin _$GolfEvent {
 ...
 String? get courseName; String? get courseDetails; String? get dressCode; int? get availableBuggies; int? get maxParticipants; List<String> get facilities; double? get memberCost; double? get guestCost; double? get breakfastCost; double? get lunchCost; double? get dinnerCost; double? get buggyCost; bool get buggyCollectedBySociety; bool get hasBreakfast; bool get hasLunch; bool get hasDinner; String? get dinnerLocation; String? get dinnerAddress; double? get societyGreenFee; double? get societyBreakfastCost; double? get societyLunchCost; double? get societyDinnerCost; List<EventNote> get notes;// DEPRECATED: Moving to feedItems
 List<String> get galleryUrls; bool get showRegistrationButton; List<String> get targetedRegistrationIds; int get teeOffInterval; bool get isGroupingPublished;// Multi-day support
 ...
 List<String> get flashUpdates; List<EventFeedItem> get feedItems; bool get isScoringLocked; bool get isStatsReleased; bool? get isStandingsReleased;// null = fall back to isStatsReleased (backward compat)
 Map<String, dynamic> get finalizedStats; String? get secondaryTemplateId;// Reference for Match Play overlay
 bool get isSeasonEvent;// [NEW] Distinguishes league events from ad hoc games
 ...
 double? get eventCost; List<EventExtraCost> get extraCosts; double get charityPot; String? get groupingStrategy;// [NEW] Per event grouping logic override
 bool? get separateGuests;// [NEW] null=auto, true=separate, false=merge
 bool get allowGuests;// [NEW] Explicitly enable/disable guest participation
 List<String> get socialGolfOverrides;
...
as double?,buggyCollectedBySociety: null == buggyCollectedBySociety ? _self.buggyCollectedBySociety : buggyCollectedBySociety // ignore: cast_nullable_to_non_nullable
as bool,hasBreakfast: null == hasBreakfast ? _self.hasBreakfast : hasBreakfast // ignore: cast_nullable_to_non_nullable
...
as bool,targetedRegistrationIds: null == targetedRegistrationIds ? _self.targetedRegistrationIds : targetedRegistrationIds // ignore: cast_nullable_to_non_nullable
as List<String>,teeOffInterval: null == teeOffInterval ? _self.teeOffInterval : teeOffInterval // ignore: cast_nullable_to_non_nullable
...
as bool,isStandingsReleased: freezed == isStandingsReleased ? _self.isStandingsReleased : isStandingsReleased // ignore: cast_nullable_to_non_nullable
...
as String?,isSeasonEvent: null == isSeasonEvent ? _self.isSeasonEvent : isSeasonEvent // ignore: cast_nullable_to_non_nullable
...
as double?,extraCosts: null == extraCosts ? _self.extraCosts : extraCosts // ignore: cast_nullable_to_non_nullable
as List<EventExtraCost>,charityPot: null == charityPot ? _self.charityPot : charityPot // ignore: cast_nullable_to_non_nullable
as double,groupingStrategy: freezed == groupingStrategy ? _self.groupingStrategy : groupingStrategy // ignore: cast_nullable_to_non_nullable
as String?,separateGuests: freezed == separateGuests ? _self.separateGuests : separateGuests // ignore: cast_nullable_to_non_nullable
as bool?,allowGuests: null == allowGuests ? _self.allowGuests : allowGuests // ignore: cast_nullable_to_non_nullable
as bool,socialGolfOverrides: null == socialGolfOverrides ? _self.socialGolfOverrides : socialGolfOverrides // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
/// Create a copy of GolfEvent
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String seasonId, @TimestampConverter()  DateTime date,  String? description,  String? imageUrl, @OptionalTimestampConverter()  DateTime? regTime, @OptionalTimestampConverter()  DateTime? teeOffTime, @OptionalTimestampConverter()  DateTime? registrationDeadline,  List<EventRegistration> registrations,  String? courseName,  String? courseDetails,  String? dressCode,  int? availableBuggies,  int? maxParticipants,  List<String> facilities,  double? memberCost,  double? guestCost,  double? breakfastCost,  double? lunchCost,  double? dinnerCost,  double? buggyCost,  bool buggyCollectedBySociety,  bool hasBreakfast,  bool hasLunch,  bool hasDinner,  String? dinnerLocation,  String? dinnerAddress,  double? societyGreenFee,  double? societyBreakfastCost,  double? societyLunchCost,  double? societyDinnerCost,  List<EventNote> notes,  List<String> galleryUrls,  bool showRegistrationButton,  List<String> targetedRegistrationIds,  int teeOffInterval,  bool isGroupingPublished,  bool isMultiDay, @OptionalTimestampConverter()  DateTime? endDate,  Map<String, dynamic> grouping,  List<Map<String, dynamic>> results,  String? courseId,  CourseConfig courseConfig,  String? selectedTeeName,  String? selectedFemaleTeeName,  List<String> flashUpdates,  List<EventFeedItem> feedItems,  bool isScoringLocked,  bool isStatsReleased,  bool? isStandingsReleased,  Map<String, dynamic> finalizedStats,  String? secondaryTemplateId,  bool isSeasonEvent,  bool isInvitational,  EventStatus status,  List<EventExpense> expenses,  bool showAwards,  List<EventAward> awards,  EventType eventType,  Map<String, double> manualCuts,  double? eventCost,  List<EventExtraCost> extraCosts,  double charityPot,  String? groupingStrategy,  bool? separateGuests,  bool allowGuests,  List<String> socialGolfOverrides)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GolfEvent() when $default != null:
return $default(_that.id,_that.title,_that.seasonId,_that.date,_that.description,_that.imageUrl,_that.regTime,_that.teeOffTime,_that.registrationDeadline,_that.registrations,_that.courseName,_that.courseDetails,_that.dressCode,_that.availableBuggies,_that.maxParticipants,_that.facilities,_that.memberCost,_that.guestCost,_that.breakfastCost,_that.lunchCost,_that.dinnerCost,_that.buggyCost,_that.buggyCollectedBySociety,_that.hasBreakfast,_that.hasLunch,_that.hasDinner,_that.dinnerLocation,_that.dinnerAddress,_that.societyGreenFee,_that.societyBreakfastCost,_that.societyLunchCost,_that.societyDinnerCost,_that.notes,_that.galleryUrls,_that.showRegistrationButton,_that.targetedRegistrationIds,_that.teeOffInterval,_that.isGroupingPublished,_that.isMultiDay,_that.endDate,_that.grouping,_that.results,_that.courseId,_that.courseConfig,_that.selectedTeeName,_that.selectedFemaleTeeName,_that.flashUpdates,_that.feedItems,_that.isScoringLocked,_that.isStatsReleased,_that.isStandingsReleased,_that.finalizedStats,_that.secondaryTemplateId,_that.isSeasonEvent,_that.isInvitational,_that.status,_that.expenses,_that.showAwards,_that.awards,_that.eventType,_that.manualCuts,_that.eventCost,_that.extraCosts,_that.charityPot,_that.groupingStrategy,_that.separateGuests,_that.allowGuests,_that.socialGolfOverrides);case _:
  return orElse();
...
class _GolfEvent extends GolfEvent {
  const _GolfEvent({required this.id, required this.title, required this.seasonId, @TimestampConverter() required this.date, this.description, this.imageUrl, @OptionalTimestampConverter() this.regTime, @OptionalTimestampConverter() this.teeOffTime, @OptionalTimestampConverter() this.registrationDeadline, final  List<EventRegistration> registrations = const [], this.courseName, this.courseDetails, this.dressCode, this.availableBuggies, this.maxParticipants, final  List<String> facilities = const [], this.memberCost, this.guestCost, this.breakfastCost, this.lunchCost, this.dinnerCost, this.buggyCost, this.buggyCollectedBySociety = false, this.hasBreakfast = false, this.hasLunch = false, this.hasDinner = true, this.dinnerLocation, this.dinnerAddress, this.societyGreenFee, this.societyBreakfastCost, this.societyLunchCost, this.societyDinnerCost, final  List<EventNote> notes = const [], final  List<String> galleryUrls = const [], this.showRegistrationButton = true, final  List<String> targetedRegistrationIds = const [], this.teeOffInterval = 10, this.isGroupingPublished = false, this.isMultiDay = false, @OptionalTimestampConverter() this.endDate, final  Map<String, dynamic> grouping = const {}, final  List<Map<String, dynamic>> results = const [], this.courseId, this.courseConfig = const CourseConfig(), this.selectedTeeName, this.selectedFemaleTeeName, final  List<String> flashUpdates = const [], final  List<EventFeedItem> feedItems = const [], this.isScoringLocked = false, this.isStatsReleased = false, this.isStandingsReleased, final  Map<String, dynamic> finalizedStats = const {}, this.secondaryTemplateId, this.isSeasonEvent = false, this.isInvitational = false, this.status = EventStatus.draft, final  List<EventExpense> expenses = const [], this.showAwards = true, final  List<EventAward> awards = const [], this.eventType = EventType.golf, final  Map<String, double> manualCuts = const {}, this.eventCost, final  List<EventExtraCost> extraCosts = const [], this.charityPot = 0.0, this.groupingStrategy, this.separateGuests, this.allowGuests = true, final  List<String> socialGolfOverrides = const []}): _registrations = registrations,_facilities = facilities,_notes = notes,_galleryUrls = galleryUrls,_targetedRegistrationIds = targetedRegistrationIds,_grouping = grouping,_results = results,_flashUpdates = flashUpdates,_feedItems = feedItems,_finalizedStats = finalizedStats,_expenses = expenses,_awards = awards,_manualCuts = manualCuts,_extraCosts = extraCosts,_socialGolfOverrides = socialGolfOverrides,super._();
...
@override@JsonKey() final  bool buggyCollectedBySociety;
...
@override@JsonKey() final  bool showRegistrationButton;
 final  List<String> _targetedRegistrationIds;
@override@JsonKey() List<String> get targetedRegistrationIds {
  if (_targetedRegistrationIds is EqualUnmodifiableListView) return _targetedRegistrationIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_targetedRegistrationIds);
}
...
@override final  bool? isStandingsReleased;
// null = fall back to isStatsReleased (backward compat)
...
@override@JsonKey() final  bool isSeasonEvent;
// [NEW] Distinguishes league events from ad hoc games
...
@override final  double? eventCost;
 final  List<EventExtraCost> _extraCosts;
@override@JsonKey() List<EventExtraCost> get extraCosts {
  if (_extraCosts is EqualUnmodifiableListView) return _extraCosts;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_extraCosts);
}

@override@JsonKey() final  double charityPot;
@override final  String? groupingStrategy;
// [NEW] Per event grouping logic override
@override final  bool? separateGuests;
// [NEW] null=auto, true=separate, false=merge
@override@JsonKey() final  bool allowGuests;
// [NEW] Explicitly enable/disable guest participation
 final  List<String> _socialGolfOverrides;
// [NEW] Explicitly enable/disable guest participation
@override@JsonKey() List<String> get socialGolfOverrides {
  if (_socialGolfOverrides is EqualUnmodifiableListView) return _socialGolfOverrides;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_socialGolfOverrides);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GolfEvent&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.seasonId, seasonId) || other.seasonId == seasonId)&&(identical(other.date, date) || other.date == date)&&(identical(other.description, description) || other.description == description)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.regTime, regTime) || other.regTime == regTime)&&(identical(other.teeOffTime, teeOffTime) || other.teeOffTime == teeOffTime)&&(identical(other.registrationDeadline, registrationDeadline) || other.registrationDeadline == registrationDeadline)&&const DeepCollectionEquality().equals(other._registrations, _registrations)&&(identical(other.courseName, courseName) || other.courseName == courseName)&&(identical(other.courseDetails, courseDetails) || other.courseDetails == courseDetails)&&(identical(other.dressCode, dressCode) || other.dressCode == dressCode)&&(identical(other.availableBuggies, availableBuggies) || other.availableBuggies == availableBuggies)&&(identical(other.maxParticipants, maxParticipants) || other.maxParticipants == maxParticipants)&&const DeepCollectionEquality().equals(other._facilities, _facilities)&&(identical(other.memberCost, memberCost) || other.memberCost == memberCost)&&(identical(other.guestCost, guestCost) || other.guestCost == guestCost)&&(identical(other.breakfastCost, breakfastCost) || other.breakfastCost == breakfastCost)&&(identical(other.lunchCost, lunchCost) || other.lunchCost == lunchCost)&&(identical(other.dinnerCost, dinnerCost) || other.dinnerCost == dinnerCost)&&(identical(other.buggyCost, buggyCost) || other.buggyCost == buggyCost)&&(identical(other.buggyCollectedBySociety, buggyCollectedBySociety) || other.buggyCollectedBySociety == buggyCollectedBySociety)&&(identical(other.hasBreakfast, hasBreakfast) || other.hasBreakfast == hasBreakfast)&&(identical(other.hasLunch, hasLunch) || other.hasLunch == hasLunch)&&(identical(other.hasDinner, hasDinner) || other.hasDinner == hasDinner)&&(identical(other.dinnerLocation, dinnerLocation) || other.dinnerLocation == dinnerLocation)&&(identical(other.dinnerAddress, dinnerAddress) || other.dinnerAddress == dinnerAddress)&&(identical(other.societyGreenFee, societyGreenFee) || other.societyGreenFee == societyGreenFee)&&(identical(other.societyBreakfastCost, societyBreakfastCost) || other.societyBreakfastCost == societyBreakfastCost)&&(identical(other.societyLunchCost, societyLunchCost) || other.societyLunchCost == societyLunchCost)&&(identical(other.societyDinnerCost, societyDinnerCost) || other.societyDinnerCost == societyDinnerCost)&&const DeepCollectionEquality().equals(other._notes, _notes)&&const DeepCollectionEquality().equals(other._galleryUrls, _galleryUrls)&&(identical(other.showRegistrationButton, showRegistrationButton) || other.showRegistrationButton == showRegistrationButton)&&const DeepCollectionEquality().equals(other._targetedRegistrationIds, _targetedRegistrationIds)&&(identical(other.teeOffInterval, teeOffInterval) || other.teeOffInterval == teeOffInterval)&&(identical(other.isGroupingPublished, isGroupingPublished) || other.isGroupingPublished == isGroupingPublished)&&(identical(other.isMultiDay, isMultiDay) || other.isMultiDay == isMultiDay)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&const DeepCollectionEquality().equals(other._grouping, _grouping)&&const DeepCollectionEquality().equals(other._results, _results)&&(identical(other.courseId, courseId) || other.courseId == courseId)&&(identical(other.courseConfig, courseConfig) || other.courseConfig == courseConfig)&&(identical(other.selectedTeeName, selectedTeeName) || other.selectedTeeName == selectedTeeName)&&(identical(other.selectedFemaleTeeName, selectedFemaleTeeName) || other.selectedFemaleTeeName == selectedFemaleTeeName)&&const DeepCollectionEquality().equals(other._flashUpdates, _flashUpdates)&&const DeepCollectionEquality().equals(other._feedItems, _feedItems)&&(identical(other.isScoringLocked, isScoringLocked) || other.isScoringLocked == isScoringLocked)&&(identical(other.isStatsReleased, isStatsReleased) || other.isStatsReleased == isStatsReleased)&&(identical(other.isStandingsReleased, isStandingsReleased) || other.isStandingsReleased == isStandingsReleased)&&const DeepCollectionEquality().equals(other._finalizedStats, _finalizedStats)&&(identical(other.secondaryTemplateId, secondaryTemplateId) || other.secondaryTemplateId == secondaryTemplateId)&&(identical(other.isSeasonEvent, isSeasonEvent) || other.isSeasonEvent == isSeasonEvent)&&(identical(other.isInvitational, isInvitational) || other.isInvitational == isInvitational)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._expenses, _expenses)&&(identical(other.showAwards, showAwards) || other.showAwards == showAwards)&&const DeepCollectionEquality().equals(other._awards, _awards)&&(identical(other.eventType, eventType) || other.eventType == eventType)&&const DeepCollectionEquality().equals(other._manualCuts, _manualCuts)&&(identical(other.eventCost, eventCost) || other.eventCost == eventCost)&&const DeepCollectionEquality().equals(other._extraCosts, _extraCosts)&&(identical(other.charityPot, charityPot) || other.charityPot == charityPot)&&(identical(other.groupingStrategy, groupingStrategy) || other.groupingStrategy == groupingStrategy)&&(identical(other.separateGuests, separateGuests) || other.separateGuests == separateGuests)&&(identical(other.allowGuests, allowGuests) || other.allowGuests == allowGuests)&&const DeepCollectionEquality().equals(other._socialGolfOverrides, _socialGolfOverrides));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,seasonId,date,description,imageUrl,regTime,teeOffTime,registrationDeadline,const DeepCollectionEquality().hash(_registrations),courseName,courseDetails,dressCode,availableBuggies,maxParticipants,const DeepCollectionEquality().hash(_facilities),memberCost,guestCost,breakfastCost,lunchCost,dinnerCost,buggyCost,buggyCollectedBySociety,hasBreakfast,hasLunch,hasDinner,dinnerLocation,dinnerAddress,societyGreenFee,societyBreakfastCost,societyLunchCost,societyDinnerCost,const DeepCollectionEquality().hash(_notes),const DeepCollectionEquality().hash(_galleryUrls),showRegistrationButton,const DeepCollectionEquality().hash(_targetedRegistrationIds),teeOffInterval,isGroupingPublished,isMultiDay,endDate,const DeepCollectionEquality().hash(_grouping),const DeepCollectionEquality().hash(_results),courseId,courseConfig,selectedTeeName,selectedFemaleTeeName,const DeepCollectionEquality().hash(_flashUpdates),const DeepCollectionEquality().hash(_feedItems),isScoringLocked,isStatsReleased,isStandingsReleased,const DeepCollectionEquality().hash(_finalizedStats),secondaryTemplateId,isSeasonEvent,isInvitational,status,const DeepCollectionEquality().hash(_expenses),showAwards,const DeepCollectionEquality().hash(_awards),eventType,const DeepCollectionEquality().hash(_manualCuts),eventCost,const DeepCollectionEquality().hash(_extraCosts),charityPot,groupingStrategy,separateGuests,allowGuests,const DeepCollectionEquality().hash(_socialGolfOverrides)]);
...
as List<String>,showRegistrationButton: null == showRegistrationButton ? _self.showRegistrationButton : showRegistrationButton // ignore: cast_nullable_to_non_nullable
as bool,targetedRegistrationIds: null == targetedRegistrationIds ? _self._targetedRegistrationIds : targetedRegistrationIds // ignore: cast_nullable_to_non_nullable
as List<String>,teeOffInterval: null == teeOffInterval ? _self.teeOffInterval : teeOffInterval // ignore: cast_nullable_to_non_nullable
as int,isGroupingPublished: null == isGroupingPublished ? _self.isGroupingPublished : isGroupingPublished // ignore: cast_nullable_to_non_nullable
as bool,isMultiDay: null == isMultiDay ? _self.isMultiDay : isMultiDay // ignore: cast_nullable_to_non_nullable
as bool,endDate: freezed == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
...
as Map<String, double>,eventCost: freezed == eventCost ? _self.eventCost : eventCost // ignore: cast_nullable_to_non_nullable
as double?,extraCosts: null == extraCosts ? _self._extraCosts : extraCosts // ignore: cast_nullable_to_non_nullable
as List<EventExtraCost>,charityPot: null == charityPot ? _self.charityPot : charityPot // ignore: cast_nullable_to_non_nullable
as double,groupingStrategy: freezed == groupingStrategy ? _self.groupingStrategy : groupingStrategy // ignore: cast_nullable_to_non_nullable
as String?,separateGuests: freezed == separateGuests ? _self.separateGuests : separateGuests // ignore: cast_nullable_to_non_nullable
as bool?,allowGuests: null == allowGuests ? _self.allowGuests : allowGuests // ignore: cast_nullable_to_non_nullable
as bool,socialGolfOverrides: null == socialGolfOverrides ? _self._socialGolfOverrides : socialGolfOverrides // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
