...
mixin _$AppNotification {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, message, timestamp, category, isRead, actionUrl);
...
extension AppNotificationPatterns on AppNotification {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AppNotification() when $default != null:
        return $default(_that.id, _that.title, _that.message, _that.timestamp,
            _that.category, _that.isRead, _that.actionUrl);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String id, String title, String message,
            DateTime timestamp, String category, bool isRead, String? actionUrl)
        $default,
  ) {
    final _that = this;
    switch (_that) {
