...
mixin _$Scorecard {
 ...
 int? get grossTotal; int? get netTotal; int? get points; double? get handicapIndex; int? get playingHandicap; AdminEditAudit? get adminEditAudit; bool get adminOverridePublish;@TimestampConverter() DateTime? get submittedAt;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime get updatedAt;
...
switch (_that) {
case _Scorecard() when $default != null:
return $default(_that.id,_that.competitionId,_that.roundId,_that.entryId,_that.submittedByUserId,_that.status,_that.scoringStatus,_that.holeScores,_that.playerVerifierScores,_that.markerId,_that.shotAttributions,_that.grossTotal,_that.netTotal,_that.points,_that.handicapIndex,_that.playingHandicap,_that.adminEditAudit,_that.adminOverridePublish,_that.submittedAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
