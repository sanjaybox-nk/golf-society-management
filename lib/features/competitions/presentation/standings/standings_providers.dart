...
final leaderboardStandingsProvider = StreamProvider.autoDispose.family<List<LeaderboardStanding>, ({String seasonId, String leaderboardId})>((ref, params) {
   final repo = ref.watch(seasonsRepositoryProvider);
   return repo.watchLeaderboardStandings(params.seasonId, params.leaderboardId);
});

final leaderboardTemplatesProvider = StreamProvider.autoDispose<List<LeaderboardConfig>>((ref) {
