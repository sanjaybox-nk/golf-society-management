...
LeaderboardConfig _$LeaderboardConfigFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    case 'orderOfMerit':
      return OrderOfMeritConfig.fromJson(json);
    case 'bestOfSeries':
      return BestOfSeriesConfig.fromJson(json);
    case 'eclectic':
      return EclecticConfig.fromJson(json);
    case 'markerCounter':
      return MarkerCounterConfig.fromJson(json);

    default:
      throw CheckedFromJsonException(json, 'runtimeType', 'LeaderboardConfig',
...
mixin _$LeaderboardConfig {
  ...
  $LeaderboardConfigCopyWith<LeaderboardConfig> get copyWith =>
      _$LeaderboardConfigCopyWithImpl<LeaderboardConfig>(
          this as LeaderboardConfig, _$identity);
...
abstract mixin class $LeaderboardConfigCopyWith<$Res> {
  factory $LeaderboardConfigCopyWith(
...
extension LeaderboardConfigPatterns on LeaderboardConfig {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(OrderOfMeritConfig value)? orderOfMerit,
    TResult Function(BestOfSeriesConfig value)? bestOfSeries,
    TResult Function(EclecticConfig value)? eclectic,
    TResult Function(MarkerCounterConfig value)? markerCounter,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case OrderOfMeritConfig() when orderOfMerit != null:
        return orderOfMerit(_that);
      case BestOfSeriesConfig() when bestOfSeries != null:
        return bestOfSeries(_that);
      case EclecticConfig() when eclectic != null:
        return eclectic(_that);
      case MarkerCounterConfig() when markerCounter != null:
        return markerCounter(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(OrderOfMeritConfig value) orderOfMerit,
    required TResult Function(BestOfSeriesConfig value) bestOfSeries,
    required TResult Function(EclecticConfig value) eclectic,
    required TResult Function(MarkerCounterConfig value) markerCounter,
  }) {
    final _that = this;
    switch (_that) {
      case OrderOfMeritConfig():
        return orderOfMerit(_that);
      case BestOfSeriesConfig():
        return bestOfSeries(_that);
      case EclecticConfig():
        return eclectic(_that);
...
class OrderOfMeritConfig extends LeaderboardConfig {
  const OrderOfMeritConfig(
      ...
      this.appearancePoints = 0,
      this.bestN = 0,
      final String? $type})
      : _positionPointsMap = positionPointsMap,
        $type = $type ?? 'orderOfMerit',
        super._();
  factory OrderOfMeritConfig.fromJson(Map<String, dynamic> json) =>
      _$OrderOfMeritConfigFromJson(json);
  ...
  @JsonKey()
  final OOMRankingBasis rankingBasis;
  final Map<int, int> _positionPointsMap;
  @JsonKey()
  Map<int, int> get positionPointsMap {
    if (_positionPointsMap is EqualUnmodifiableMapView)
      return _positionPointsMap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_positionPointsMap);
  }

  @JsonKey()
  final int appearancePoints;
  @JsonKey()
  final int bestN;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $OrderOfMeritConfigCopyWith<OrderOfMeritConfig> get copyWith =>
      _$OrderOfMeritConfigCopyWithImpl<OrderOfMeritConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$OrderOfMeritConfigToJson(
      this,
    );
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._positionPointsMap, _positionPointsMap) &&
            (identical(other.appearancePoints, appearancePoints) ||
                other.appearancePoints == appearancePoints) &&
...
/// @nodoc
abstract mixin class $OrderOfMeritConfigCopyWith<$Res>
    implements $LeaderboardConfigCopyWith<$Res> {
  factory $OrderOfMeritConfigCopyWith(
          OrderOfMeritConfig value, $Res Function(OrderOfMeritConfig) _then) =
      _$OrderOfMeritConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
    ...
    return _then(OrderOfMeritConfig(
      ...
      source: null == source
          ...
          : source // ignore: cast_nullable_to_non_nullable
              as OOMSource,
      rankingBasis: null == rankingBasis
          ? _self.rankingBasis
          : rankingBasis // ignore: cast_nullable_to_non_nullable
              as OOMRankingBasis,
      positionPointsMap: null == positionPointsMap
          ? _self._positionPointsMap
          : positionPointsMap // ignore: cast_nullable_to_non_nullable
              as Map<int, int>,
      appearancePoints: null == appearancePoints
          ? _self.appearancePoints
          : appearancePoints // ignore: cast_nullable_to_non_nullable
              as int,
      bestN: null == bestN
          ? _self.bestN
...
class BestOfSeriesConfig extends LeaderboardConfig {
  const BestOfSeriesConfig(
      ...
      this.tiePolicy = TiePolicy.countback,
      final Map<int, int> positionPointsMap = const {},
      this.appearancePoints = 0,
      final String? $type})
      : _positionPointsMap = positionPointsMap,
        $type = $type ?? 'bestOfSeries',
        super._();
  factory BestOfSeriesConfig.fromJson(Map<String, dynamic> json) =>
      _$BestOfSeriesConfigFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BestOfSeriesConfigCopyWith<BestOfSeriesConfig> get copyWith =>
      _$BestOfSeriesConfigCopyWithImpl<BestOfSeriesConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BestOfSeriesConfigToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.tiePolicy, tiePolicy) ||
                other.tiePolicy == tiePolicy) &&
            const DeepCollectionEquality()
                .equals(other._positionPointsMap, _positionPointsMap) &&
            (identical(other.appearancePoints, appearancePoints) ||
                other.appearancePoints == appearancePoints));
...
/// @nodoc
abstract mixin class $BestOfSeriesConfigCopyWith<$Res>
    implements $LeaderboardConfigCopyWith<$Res> {
  factory $BestOfSeriesConfigCopyWith(
          BestOfSeriesConfig value, $Res Function(BestOfSeriesConfig) _then) =
      _$BestOfSeriesConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
    ...
    return _then(BestOfSeriesConfig(
      ...
      metric: null == metric
          ...
          : metric // ignore: cast_nullable_to_non_nullable
              as BestOfMetric,
      scoringType: null == scoringType
          ? _self.scoringType
          : scoringType // ignore: cast_nullable_to_non_nullable
              as ScoringType,
      tiePolicy: null == tiePolicy
          ? _self.tiePolicy
          : tiePolicy // ignore: cast_nullable_to_non_nullable
              as TiePolicy,
      positionPointsMap: null == positionPointsMap
          ? _self._positionPointsMap
          : positionPointsMap // ignore: cast_nullable_to_non_nullable
...
class EclecticConfig extends LeaderboardConfig {
  const EclecticConfig(
      ...
      : $type = $type ?? 'eclectic',
        super._();
  factory EclecticConfig.fromJson(Map<String, dynamic> json) =>
      _$EclecticConfigFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $EclecticConfigCopyWith<EclecticConfig> get copyWith =>
      _$EclecticConfigCopyWithImpl<EclecticConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EclecticConfigToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $EclecticConfigCopyWith<$Res>
    implements $LeaderboardConfigCopyWith<$Res> {
  factory $EclecticConfigCopyWith(
          EclecticConfig value, $Res Function(EclecticConfig) _then) =
      _$EclecticConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
  ...
  $Res call({
    ...
    return _then(EclecticConfig(
      ...
      metric: null == metric
          ...
          : metric // ignore: cast_nullable_to_non_nullable
              as EclecticMetric,
      handicapPercentage: null == handicapPercentage
          ? _self.handicapPercentage
          : handicapPercentage // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
class MarkerCounterConfig extends LeaderboardConfig {
  const MarkerCounterConfig(
      ...
      : _targetTypes = targetTypes,
        $type = $type ?? 'markerCounter',
        super._();
  factory MarkerCounterConfig.fromJson(Map<String, dynamic> json) =>
      _$MarkerCounterConfigFromJson(json);
  ...
  @JsonKey()
  final HoleFilter holeFilter;
  @JsonKey()
  final MarkerRankingMethod rankingMethod;
  @JsonKey()
  final int bestN;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MarkerCounterConfigCopyWith<MarkerCounterConfig> get copyWith =>
      _$MarkerCounterConfigCopyWithImpl<MarkerCounterConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MarkerCounterConfigToJson(
      this,
    );
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.holeFilter, holeFilter) ||
                other.holeFilter == holeFilter) &&
            (identical(other.rankingMethod, rankingMethod) ||
                other.rankingMethod == rankingMethod) &&
            (identical(other.bestN, bestN) || other.bestN == bestN));
  }
...
/// @nodoc
abstract mixin class $MarkerCounterConfigCopyWith<$Res>
    implements $LeaderboardConfigCopyWith<$Res> {
  factory $MarkerCounterConfigCopyWith(
          MarkerCounterConfig value, $Res Function(MarkerCounterConfig) _then) =
      _$MarkerCounterConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
    ...
    return _then(MarkerCounterConfig(
      ...
      targetTypes: null == targetTypes
          ...
          : targetTypes // ignore: cast_nullable_to_non_nullable
              as Set<MarkerType>,
      holeFilter: null == holeFilter
          ? _self.holeFilter
          : holeFilter // ignore: cast_nullable_to_non_nullable
              as HoleFilter,
      rankingMethod: null == rankingMethod
          ? _self.rankingMethod
          : rankingMethod // ignore: cast_nullable_to_non_nullable
              as MarkerRankingMethod,
      bestN: null == bestN
          ? _self.bestN
          : bestN // ignore: cast_nullable_to_non_nullable
              as int,
