...
_Member _$MemberFromJson(Map<String, dynamic> json) => _Member(
      ...
      joinedDate:
          const OptionalTimestampConverter().fromJson(json['joinedDate']),
      membershipEndDate: const OptionalTimestampConverter()
          .fromJson(json['membershipEndDate']),
      renewalStatus: $enumDecodeNullable(
              _$MemberRenewalStatusEnumMap, json['renewalStatus']) ??
...
Map<String, dynamic> _$MemberToJson(_Member instance) => <String, dynamic>{
      ...
      'joinedDate':
          const OptionalTimestampConverter().toJson(instance.joinedDate),
      'membershipEndDate':
          const OptionalTimestampConverter().toJson(instance.membershipEndDate),
